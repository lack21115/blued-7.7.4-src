...
public class MediaButtonReceiver extends BroadcastReceiver {
  ...
  public void onReceive(Context paramContext, Intent paramIntent) {
    ...
    if (componentName != null) {
      ...
      a((Context)stringBuilder, paramIntent);
      return;
    } 
  ...
  static class MediaButtonConnectionCallback extends MediaBrowserCompat.ConnectionCallback {
    ...
    void a(MediaBrowserCompat param1MediaBrowserCompat) {
      this.d = param1MediaBrowserCompat;
    }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\androidx\media\session\MediaButtonReceiver.class
