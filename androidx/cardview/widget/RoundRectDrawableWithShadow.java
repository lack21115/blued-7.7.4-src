...
class RoundRectDrawableWithShadow extends Drawable {
  ...
  static float b(float paramFloat1, float paramFloat2, boolean paramBoolean) {
    float f = paramFloat1;
    if (paramBoolean)
      f = (float)(paramFloat1 + (1.0D - b) * paramFloat2); 
    return f;
  }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\androidx\cardview\widget\RoundRectDrawableWithShadow.class
