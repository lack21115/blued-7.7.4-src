...
public abstract class ConstraintHelper extends View {
  ...
  public void updatePreLayout(ConstraintLayout paramConstraintLayout) {
    ...
    for (int i = 0; i < this.b; i++) {
      ...
      if (view != null)
        this.d.add(paramConstraintLayout.getViewWidget(view)); 
    } 
  }
  ...
  public void validateParams() {
    ...
    if (layoutParams instanceof ConstraintLayout.LayoutParams)
      ((ConstraintLayout.LayoutParams)layoutParams).s = (ConstraintWidget)this.d; 
  }
}


/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\androidx\constraintlayout\widget\ConstraintHelper.class
