  ...
  public static ColorStateList getNamedColorStateList(TypedArray paramTypedArray, XmlPullParser paramXmlPullParser, Resources.Theme paramTheme, String paramString, int paramInt) {
    if (hasAttribute(paramXmlPullParser, paramString)) {
      ...
      if (typedValue.type != 2)
        return (typedValue.type >= 28 && typedValue.type <= 31) ? a(typedValue) : ColorStateListInflaterCompat.inflate(paramTypedArray.getResources(), paramTypedArray.getResourceId(paramInt, 0), paramTheme); 
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\androidx\core\content\res\TypedArrayUtils.class
