  ...
  public static MenuItem setOnActionExpandListener(MenuItem paramMenuItem, OnActionExpandListener paramOnActionExpandListener) {
    return paramMenuItem.setOnActionExpandListener(new MenuItem.OnActionExpandListener(paramOnActionExpandListener) {
          public boolean onMenuItemActionCollapse(MenuItem param1MenuItem) {
            return this.a.onMenuItemActionCollapse(param1MenuItem);
          }
          
          public boolean onMenuItemActionExpand(MenuItem param1MenuItem) {
            return this.a.onMenuItemActionExpand(param1MenuItem);
          }
        });
  }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\androidx\core\view\MenuItemCompat.class
