...
public final class EditorInfoCompat {
  ...
  static int a(EditorInfo paramEditorInfo) {
  ...
  public static String[] getContentMimeTypes(EditorInfo paramEditorInfo) {
    ...
    if (Build.VERSION.SDK_INT >= 25) {
      ...
      return (arrayOfString1 != null) ? arrayOfString1 : a;
    } 
    ...
    return (arrayOfString2 != null) ? arrayOfString2 : a;
  }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\androidx\core\view\inputmethod\EditorInfoCompat.class
