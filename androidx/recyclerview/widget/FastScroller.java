...
class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
  ...
  private final RecyclerView.OnScrollListener E = new RecyclerView.OnScrollListener(this) {
  ...
  FastScroller(RecyclerView paramRecyclerView, StateListDrawable paramStateListDrawable1, Drawable paramDrawable1, StateListDrawable paramStateListDrawable2, Drawable paramDrawable2, int paramInt1, int paramInt2, int paramInt3) {
    ...
    this.a.setAlpha(255);
    this.b.setAlpha(255);
    this.i.addListener((Animator.AnimatorListener)new AnimatorListener(this));
    this.i.addUpdateListener(new AnimatorUpdater(this));
  ...
  private void a(Canvas paramCanvas) {
    ...
    if (d()) {
      ...
      paramCanvas.translate(this.o, m);
  ...
  private boolean d() {
    return (ViewCompat.getLayoutDirection((View)this.w) == 1);
  }
  ...
  boolean a(float paramFloat1, float paramFloat2) {
    if (d() ? (paramFloat1 <= (this.o / 2)) : (paramFloat1 >= (this.u - this.o))) {
      int i = this.d;
      int j = this.c;
  ...
  class AnimatorListener extends AnimatorListenerAdapter {
    ...
    AnimatorListener(FastScroller this$0) {}
    ...
    public void onAnimationEnd(Animator param1Animator) {
      ...
      if (((Float)this.a.i.getAnimatedValue()).floatValue() == 0.0F) {
        FastScroller fastScroller1 = this.a;
        fastScroller1.j = 0;
        fastScroller1.a(0);
        return;
      } 
  ...
  class AnimatorUpdater implements ValueAnimator.AnimatorUpdateListener {
    AnimatorUpdater(FastScroller this$0) {}
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\androidx\recyclerview\widget\FastScroller.class
