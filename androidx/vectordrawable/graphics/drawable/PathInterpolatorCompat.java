    ...
    if (TypedArrayUtils.hasAttribute((XmlPullParser)stringBuilder, "controlX1")) {
      if (TypedArrayUtils.hasAttribute((XmlPullParser)stringBuilder, "controlY1")) {
        ...
        if (bool == TypedArrayUtils.hasAttribute((XmlPullParser)stringBuilder, "controlY2")) {
          ...
          a(f1, f2, TypedArrayUtils.getNamedFloat((TypedArray)str, (XmlPullParser)stringBuilder, "controlX2", 2, 0.0F), TypedArrayUtils.getNamedFloat((TypedArray)str, (XmlPullParser)stringBuilder, "controlY2", 3, 0.0F));
          return;
        } 
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\androidx\vectordrawable\graphics\drawable\PathInterpolatorCompat.class
