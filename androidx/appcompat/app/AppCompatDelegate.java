...
public abstract class AppCompatDelegate {
  ...
  private static void a() {
    synchronized (c) {
      Iterator<WeakReference<AppCompatDelegate>> iterator = b.iterator();
  ...
  static void a(AppCompatDelegate paramAppCompatDelegate) {
    synchronized (c) {
      c(paramAppCompatDelegate);
      b.add(new WeakReference<AppCompatDelegate>(paramAppCompatDelegate));
      return;
    } 
  }
  
  static void b(AppCompatDelegate paramAppCompatDelegate) {
    synchronized (c) {
      c(paramAppCompatDelegate);
      return;
    } 
  ...
  private static void c(AppCompatDelegate paramAppCompatDelegate) {
    synchronized (c) {
      Iterator<WeakReference<AppCompatDelegate>> iterator = b.iterator();
      while (iterator.hasNext()) {
        AppCompatDelegate appCompatDelegate = ((WeakReference<AppCompatDelegate>)iterator.next()).get();
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\androidx\appcompat\app\AppCompatDelegate.class
