...
class AppCompatTextViewAutoSizeHelper {
  ...
  private void a(float paramFloat1, float paramFloat2, float paramFloat3) throws IllegalArgumentException {
    if (paramFloat1 > 0.0F) {
  ...
  void a(AttributeSet paramAttributeSet, int paramInt) {
    ...
    float f2;
    float f3;
    TypedArray typedArray = this.m.obtainStyledAttributes(paramAttributeSet, R.styleable.AppCompatTextView, paramInt, 0);
    if (typedArray.hasValue(R.styleable.AppCompatTextView_autoSizeTextType))
      this.d = typedArray.getInt(R.styleable.AppCompatTextView_autoSizeTextType, 0); 
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\androidx\appcompat\widget\AppCompatTextViewAutoSizeHelper.class
