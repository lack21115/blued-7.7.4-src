...
class AppCompatCompoundButtonHelper {
  ...
  int a(int paramInt) {
    ...
    if (Build.VERSION.SDK_INT < 17) {
      Drawable drawable = CompoundButtonCompat.getButtonDrawable(this.a);
      i = paramInt;
      if (drawable != null)
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\androidx\appcompat\widget\AppCompatCompoundButtonHelper.class
