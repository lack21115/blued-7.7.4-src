...
public class ActionBarContextView extends AbsActionBarView {
  ...
  public ActionBarContextView(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    ...
    this.n = tintTypedArray.getResourceId(R.styleable.ActionMode_titleTextStyle, 0);
    this.o = tintTypedArray.getResourceId(R.styleable.ActionMode_subtitleTextStyle, 0);
    this.e = tintTypedArray.getLayoutDimension(R.styleable.ActionMode_height, 0);
    this.q = tintTypedArray.getResourceId(R.styleable.ActionMode_closeItemLayout, R.layout.abc_action_mode_close_item_material);
  ...
  public boolean hideOverflowMenu() {
    return (this.d != null) ? this.d.hideOverflowMenu() : false;
  }
  ...
  public void initForMode(ActionMode paramActionMode) {
    ...
    this.i.findViewById(R.id.action_mode_close_button).setOnClickListener(new View.OnClickListener(this, paramActionMode) {
    ...
    menuBuilder.addMenuPresenter((MenuPresenter)this.d, this.b);
    this.c = (ActionMenuView)this.d.getMenuView(this);
    ViewCompat.setBackground((View)this.c, null);
    addView((View)this.c, layoutParams);
  }
  
  public boolean isOverflowMenuShowing() {
    return (this.d != null) ? this.d.isOverflowMenuShowing() : false;
  }
    ...
    if (linearLayout != null) {
      ...
      if (this.j == null) {
        ...
        if (linearLayout.getVisibility() != 8)
          paramInt4 = paramInt2 + a((View)this.k, paramInt2, j, k, paramBoolean); 
      } 
    } 
    View view1 = this.j;
    if (view1 != null)
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\androidx\appcompat\widget\ActionBarContextView.class
