...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
  ...
  class HostCallbacks extends FragmentHostCallback<FragmentActivity> implements OnBackPressedDispatcherOwner, ViewModelStoreOwner {
    ...
    public boolean onShouldShowRequestPermissionRationale(String param1String) {
      return ActivityCompat.shouldShowRequestPermissionRationale((Activity)this.a, param1String);
    }
    
    public void onStartActivityFromFragment(Fragment param1Fragment, Intent param1Intent, int param1Int) {
      this.a.startActivityFromFragment(param1Fragment, param1Intent, param1Int);
    }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\androidx\fragment\app\FragmentActivity.class
