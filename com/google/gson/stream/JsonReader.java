  ...
  private boolean skipTo(String paramString) throws IOException {
    ...
    label20: while (true) {
      ...
      if (k + i <= m || fillBuffer(i)) {
        ...
        while (j < i) {
          if (this.buffer[this.pos + j] != paramString.charAt(j)) {
            this.pos++;
            continue label20;
          } 
          j++;
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued6949884-dex2jar.jar!\com\google\gson\stream\JsonReader.class
