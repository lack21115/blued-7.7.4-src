...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
  ...
  static <K, V> Node<K, V>[] doubleCapacity(Node<K, V>[] paramArrayOfNode) {
    int j = paramArrayOfNode.length;
    Node[] arrayOfNode = new Node[j * 2];
    ...
    for (int i = 0; i < j; i++) {
      Node<K, V> node = paramArrayOfNode[i];
      if (node != null) {
  ...
  final class EntrySet extends AbstractSet<Map.Entry<K, V>> {
    ...
    public boolean contains(Object param1Object) {
      return (param1Object instanceof Map.Entry && LinkedHashTreeMap.this.findByEntry((Map.Entry<?, ?>)param1Object) != null);
    }
  ...
  final class KeySet extends AbstractSet<K> {
    ...
    public boolean remove(Object param1Object) {
      return (LinkedHashTreeMap.this.removeInternalByKey(param1Object) != null);
    }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued6949884-dex2jar.jar!\com\google\gson\internal\LinkedHashTreeMap.class
