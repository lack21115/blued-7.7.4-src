...
public final class TreeTypeAdapter<T> extends TypeAdapter<T> {
  ...
  static final class SingleTypeFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson param1Gson, TypeToken<T> param1TypeToken) {
      ...
      return bool ? new TreeTypeAdapter<T>((JsonSerializer)this.serializer, (JsonDeserializer)this.deserializer, param1Gson, param1TypeToken, this) : null;
    }
  }
}


/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued6949884-dex2jar.jar!\com\google\gson\internal\bind\TreeTypeAdapter.class
