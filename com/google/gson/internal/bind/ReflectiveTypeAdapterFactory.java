    ...
    while (paramClass != Object.class) {
      for (Field field : paramClass.getDeclaredFields()) {
        ...
        if (bool1 || bool2) {
          ...
          Type type1 = .Gson.Types.resolve(typeToken.getType(), paramClass, field.getGenericType());
      ...
      typeToken = TypeToken.get(.Gson.Types.resolve(typeToken.getType(), paramClass, paramClass.getGenericSuperclass()));
      paramClass = typeToken.getRawType();
    } 
    return (Map)linkedHashMap;
  }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued6949884-dex2jar.jar!\com\google\gson\internal\bind\ReflectiveTypeAdapterFactory.class
