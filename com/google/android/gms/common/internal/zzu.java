...
public final class zzu {
  private static final SimpleArrayMap zzgfv = new SimpleArrayMap();
  ...
  private static String zzcn(Context paramContext) {
    ...
    try {
      ...
      return zzbig.mContext.getPackageManager().getApplicationLabel(zzbig.mContext.getPackageManager().getApplicationInfo(str, 0)).toString();
  ...
  private static String zzs(Context paramContext, String paramString) {
    synchronized (zzgfv) {
      ...
      if (resources == null)
        return null; 
      int i = BuildHooksAndroid.getIdentifier(resources, paramString, "string", "com.google.android.gms");
      if (i == 0) {
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued2362740-dex2jar.jar!\com\google\android\gms\common\internal\zzu.class
