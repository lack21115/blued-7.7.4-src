...
public abstract class zzo extends LifecycleCallback implements DialogInterface.OnCancelListener {
  ...
  protected final AtomicReference zzfut = new AtomicReference(null);
  ...
  private static int zza(zzp paramzzp) {
    return (paramzzp == null) ? -1 : paramzzp.zzfuv;
  }
  ...
  public final void onCreate(Bundle paramBundle) {
    ...
    if (paramBundle != null) {
      AtomicReference<Bundle> atomicReference = this.zzfut;
  ...
  public final void onSaveInstanceState(Bundle paramBundle) {
    ...
    if (zzp != null) {
      ...
      paramBundle.putInt("failed_client_id", zzp.zzfuv);
      paramBundle.putInt("failed_status", zzp.zzfuw.zzcc);
      paramBundle.putParcelable("failed_resolution", (Parcelable)zzp.zzfuw.zzekd);
    } 
  }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued2362740-dex2jar.jar!\com\google\android\gms\common\api\internal\zzo.class
