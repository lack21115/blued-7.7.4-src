...
public final class MaterialContainerTransform extends Transition {
  ...
  private static final String[] i = new String[] { "materialContainerTransition:bounds", "materialContainerTransition:shapeAppearance" };
  ...
  private static final ProgressThresholdsGroup k = new ProgressThresholdsGroup(new ProgressThresholds(0.6F, 0.9F), new ProgressThresholds(0.0F, 1.0F), new ProgressThresholds(0.0F, 0.9F), new ProgressThresholds(0.3F, 0.9F));
  ...
  private static final ProgressThresholdsGroup m = new ProgressThresholdsGroup(new ProgressThresholds(0.6F, 0.9F), new ProgressThresholds(0.0F, 0.9F), new ProgressThresholds(0.0F, 0.9F), new ProgressThresholds(0.2F, 0.9F));
  ...
  private static RectF a(View paramView1, View paramView2, float paramFloat1, float paramFloat2) {
    RectF rectF;
    if (paramView2 != null) {
      rectF = TransitionUtils.b(paramView2);
  ...
  private ProgressThresholdsGroup a(boolean paramBoolean, ProgressThresholdsGroup paramProgressThresholdsGroup1, ProgressThresholdsGroup paramProgressThresholdsGroup2) {
    ...
    return new ProgressThresholdsGroup(TransitionUtils.<ProgressThresholds>a(this.D, ProgressThresholdsGroup.a(paramProgressThresholdsGroup1)), TransitionUtils.<ProgressThresholds>a(this.E, ProgressThresholdsGroup.b(paramProgressThresholdsGroup1)), TransitionUtils.<ProgressThresholds>a(this.F, ProgressThresholdsGroup.c(paramProgressThresholdsGroup1)), TransitionUtils.<ProgressThresholds>a(this.G, ProgressThresholdsGroup.d(paramProgressThresholdsGroup1)));
  }
  ...
  private ProgressThresholdsGroup c(boolean paramBoolean) {
    PathMotion pathMotion = getPathMotion();
    return (pathMotion instanceof androidx.transition.ArcMotion || pathMotion instanceof MaterialArcMotion) ? a(paramBoolean, l, m) : a(paramBoolean, j, k);
  }
  
  public void captureEndValues(TransitionValues paramTransitionValues) {
    a(paramTransitionValues, this.A, this.r, this.C);
  }
  
  public void captureStartValues(TransitionValues paramTransitionValues) {
    a(paramTransitionValues, this.z, this.q, this.B);
  }
  ...
  public Animator createAnimator(ViewGroup paramViewGroup, TransitionValues paramTransitionValues1, TransitionValues paramTransitionValues2) {
    if (paramTransitionValues1 != null) {
      ...
      if (this.p == view1.getId()) {
        View view5 = (View)view1.getParent();
        View view4 = view1;
        view1 = view5;
      } else {
        view1 = TransitionUtils.b(view1, this.p);
        paramTransitionValues1 = null;
      } 
      RectF rectF2 = TransitionUtils.b(view1);
      ...
      TransitionDrawable transitionDrawable = new TransitionDrawable(getPathMotion(), view3, rectF3, shapeAppearanceModel1, a(this.I, view3), view2, rectF4, shapeAppearanceModel2, a(this.J, view2), this.s, this.t, this.u, this.v, bool, this.H, FadeModeEvaluators.a(this.x, bool), FitModeEvaluators.a(this.y, bool, rectF3, rectF4), c(bool), this.n);
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7575468-dex2jar.jar!\com\google\android\material\transition\MaterialContainerTransform.class
