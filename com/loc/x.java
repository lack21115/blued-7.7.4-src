...
public final class x {
  ...
  public static int a(Context paramContext, String paramString1, String paramString2, int paramInt) {
    try {
      ...
      paramContext = null;
      ab.b((Throwable)paramContext, "csp", "giv");
    } 
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3) {
    if (paramContext != null && !TextUtils.isEmpty(paramString2)) {
      ...
      try {
        ...
        editor.putString(paramString2, u.g(a(paramContext, u.a(paramString3))));
        return;
      } finally {
        paramContext = null;
      } 
  ...
  public static void a(SharedPreferences.Editor paramEditor) {
    ...
    try {
      ...
      paramEditor = null;
      y.a((Throwable)paramEditor, "sp", "cm");
    } 
  }
  ...
  public static void a(SharedPreferences.Editor paramEditor, String paramString, int paramInt) {
    try {
      ...
      paramEditor = null;
      ab.b((Throwable)paramEditor, "csp", "putPrefsInt");
    } 
  }
  ...
  public static void a(SharedPreferences.Editor paramEditor, String paramString, boolean paramBoolean) {
    try {
      ...
      paramEditor = null;
      ab.b((Throwable)paramEditor, "csp", "setPrefsStr");
    } 
  }
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2, boolean paramBoolean) {
    try {
      ...
      paramContext = null;
      ab.b((Throwable)paramContext, "csp", "gbv");
    } 
  }
  ...
  private static byte[] a(Context paramContext) {
    ...
    if (arrayOfByte2 != null && arrayOfByte2.length > 0)
      return arrayOfByte2; 
    byte[] arrayOfByte1 = k.f(paramContext).getBytes();
    a = arrayOfByte1;
    return arrayOfByte1;
  }
  ...
  private static byte[] a(Context paramContext, byte[] paramArrayOfbyte) {
    try {
      return o.b(a(paramContext), paramArrayOfbyte, b(paramContext));
    } finally {
      paramContext = null;
    } 
  }
  ...
  public static String b(Context paramContext, String paramString1, String paramString2) {
    if (paramContext == null)
      return ""; 
    try {
      return u.a(b(paramContext, u.d(paramContext.getSharedPreferences(paramString1, 0).getString(paramString2, ""))));
    } finally {
      paramContext = null;
    } 
  }
  ...
  public static String b(Context paramContext, String paramString1, String paramString2, String paramString3) {
    ...
    try {
      ...
      paramContext = null;
      ab.b((Throwable)paramContext, "csp", "gsv");
    } 
  }
  ...
  private static byte[] b(Context paramContext, byte[] paramArrayOfbyte) {
    try {
      return o.a(a(paramContext), paramArrayOfbyte, b(paramContext));
  ...
  public static long c(Context paramContext, String paramString1, String paramString2) {
    try {
      ...
      paramContext = null;
      ab.b((Throwable)paramContext, "csp", "glv");
    } 
  }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued6949884-dex2jar.jar!\com\loc\x.class
