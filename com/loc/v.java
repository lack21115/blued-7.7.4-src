...
public final class v {
  ...
  private static volatile ConcurrentHashMap<String, String> l = new ConcurrentHashMap<String, String>(8);
  ...
  public static String a(String paramString) {
    ...
    //   3: aload_2
    //   4: astore_1
    //   5: getstatic com/loc/v.l : Ljava/util/concurrent/ConcurrentHashMap;
    //   8: astore_3
    //   9: aload_2
    //   10: astore_1
    //   11: aload_3
    ...
    //   13: aload_2
    //   14: astore_1
    //   15: getstatic com/loc/v.l : Ljava/util/concurrent/ConcurrentHashMap;
    //   18: ifnull -> 49
    //   21: aload_2
    //   22: astore_1
    //   23: getstatic com/loc/v.l : Ljava/util/concurrent/ConcurrentHashMap;
    //   26: aload_0
    //   27: invokevirtual containsKey : (Ljava/lang/Object;)Z
    //   30: ifeq -> 49
    //   33: aload_2
    //   34: astore_1
    //   35: getstatic com/loc/v.l : Ljava/util/concurrent/ConcurrentHashMap;
    //   38: aload_0
  ...
  public static byte[] a(int paramInt) {
    ...
    System.arraycopy(c, paramInt * 4, arrayOfByte, 0, 4);
    paramInt = arrayOfByte[0];
    byte b = arrayOfByte[1];
    int i = (arrayOfByte[2] & 0xFF) * 256 + (arrayOfByte[3] & 0xFF);
    arrayOfByte = new byte[i];
    System.arraycopy(c, (paramInt & 0xFF) * 256 + (b & 0xFF), arrayOfByte, 0, i);
    return arrayOfByte;
  }
}


/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued6949884-dex2jar.jar!\com\loc\v.class
