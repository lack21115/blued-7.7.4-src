...
public class MultiDexForMemoryDex {
  ...
  private static ArrayList<Object> installDexes(ClassLoader paramClassLoader, ByteBuffer[] paramArrayOfByteBuffer, boolean paramBoolean1, boolean paramBoolean2) {
    try {
      Field field = findField(paramClassLoader, "pathList");
      try {
        return V26.install(paramClassLoader, field, paramArrayOfByteBuffer, paramBoolean1, paramBoolean2);
  ...
  private static final class V26 {
    ...
    private static ArrayList<Object> install(ClassLoader param1ClassLoader, Field param1Field, ByteBuffer[] param1ArrayOfByteBuffer, boolean param1Boolean1, boolean param1Boolean2) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException {
      throw new VerifyError("bad dex opcode");
    }
    
    private static Object[] makeDexElements(Object param1Object, ByteBuffer[] param1ArrayOfByteBuffer, List<IOException> param1List) {
      try {
        MultiDexForMemoryDex.findMethod(param1Object, "makeInMemoryDexElements", new Class[] { ByteBuffer[].class, List.class });
        try {
          throw new VerifyError("bad dex opcode");
        } catch (IllegalAccessException illegalAccessException) {
          throw new VerifyError("bad dex opcode");
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued555128-dex2jar.jar!\com\wrapper\proxyapplication\MultiDexForMemoryDex.class
