...
public final class MultiDex {
  ...
  private static ArrayList<Object> installDexes(ClassLoader paramClassLoader, String paramString1, String paramString2, int paramInt, boolean paramBoolean1, boolean paramBoolean2) {
    ...
    try {
      ...
      try {
        return V19.install(paramClassLoader, field, arrayList, file, paramInt, paramBoolean1, paramBoolean2);
      } catch (IllegalArgumentException illegalArgumentException) {
        throw new VerifyError("bad dex opcode");
      } catch (IllegalAccessException illegalAccessException) {
        throw new VerifyError("bad dex opcode");
  ...
  private static ArrayList<Object> installDexes(ClassLoader paramClassLoader, String paramString1, String paramString2, boolean paramBoolean1, boolean paramBoolean2) {
    ArrayList<File> arrayList = splitPaths(paramString1);
    File file = new File(paramString2);
    try {
      Field field = findField(paramClassLoader, "pathList");
      try {
        return V19.install(paramClassLoader, field, arrayList, file, paramBoolean1, paramBoolean2);
      } catch (IllegalArgumentException illegalArgumentException) {
        throw new VerifyError("bad dex opcode");
      } catch (IllegalAccessException illegalAccessException) {
        throw new VerifyError("bad dex opcode");
  ...
  private static void preparetoinstallDexes(ClassLoader paramClassLoader, int paramInt) {
    try {
      findField(paramClassLoader, "pathList");
      try {
        throw new VerifyError("bad dex opcode");
  ...
  private static final class V19 {
    ...
    private static ArrayList<Object> install(ClassLoader param1ClassLoader, Field param1Field, List<File> param1List, File param1File, int param1Int, boolean param1Boolean1, boolean param1Boolean2) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException {
      throw new VerifyError("bad dex opcode");
    }
    
    private static ArrayList<Object> install(ClassLoader param1ClassLoader, Field param1Field, List<File> param1List, File param1File, boolean param1Boolean1, boolean param1Boolean2) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException {
      throw new VerifyError("bad dex opcode");
    }
    ...
    private static Object[] makeDexElements(Object param1Object, ArrayList<File> param1ArrayList, File param1File, ArrayList<IOException> param1ArrayList1) {
      try {
        MultiDex.findMethod(param1Object, "makeDexElements", new Class[] { ArrayList.class, File.class });
        try {
          throw new VerifyError("bad dex opcode");
        } catch (IllegalAccessException illegalAccessException) {
          throw new VerifyError("bad dex opcode");
        ...
        try {
          MultiDex.findMethod(param1Object, "makeDexElements", new Class[] { ArrayList.class, File.class, ArrayList.class });
          try {
            throw new VerifyError("bad dex opcode");
          } catch (IllegalAccessException illegalAccessException) {
            throw new VerifyError("bad dex opcode");
          ...
          try {
            MultiDex.findMethod(param1Object, "makePathElements", new Class[] { List.class, File.class, List.class });
            try {
              throw new VerifyError("bad dex opcode");
            } catch (IllegalAccessException illegalAccessException) {
              throw new VerifyError("bad dex opcode");
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued555128-dex2jar.jar!\com\wrapper\proxyapplication\MultiDex.class
