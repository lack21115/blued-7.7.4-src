...
import com.tencent.ams.a.a.a.b;
...
public class c {
  ...
  private static String a(String paramString) {
    ...
    try {
      ...
      InputStream inputStream = ad.a(httpURLConnection).getInputStream();
    ...
    } catch (MalformedURLException|java.io.IOException malformedURLException) {
      return null;
    } 
  }
  ...
  public static void a(Context paramContext) {
    // Byte code:
    //   0: aload_0
    //   1: invokestatic b : (Landroid/content/Context;)Lcom/tencent/ams/a/a/b/g;
    //   4: astore_1
    //   5: aload_1
    //   6: ifnull -> 30
    //   9: aload_1
    ...
    //   74: iconst_0
    //   75: aconst_null
    //   76: invokestatic a : (IILcom/qq/e/comm/plugin/y/c;)V
    //   79: aload_1
    //   80: astore_0
    //   81: aload_0
    //   82: invokestatic a : (Lcom/tencent/ams/a/a/b/g;)V
    //   85: aload_0
    //   86: putstatic com/tencent/ams/a/a/c/c.a : Lcom/tencent/ams/a/a/b/g;
    //   89: return
  }
  
  public static void a(Context paramContext, String paramString) {
    g g1 = b(paramContext, paramString);
    if (g1 != null) {
      a = g1;
      a(a);
    } 
  ...
  private static void a(g paramg) {
    ...
    if (paramg != null)
      try {
        String str = paramg.a.a;
        if (str != null && !"".equals(paramg.a.a))
          b.a = Integer.parseInt(paramg.a.a); 
        if (paramg.a.b != null && !"".equals(paramg.a.b))
          b.b = Integer.parseInt(paramg.a.b); 
        if (paramg.a.c != null && !"".equals(paramg.a.c))
          b.c = Integer.parseInt(paramg.a.c); 
        return;
  ...
  public static g b(Context paramContext) {
    try {
      String str = d.a(paramContext, "cn.com.mma.mobile.tracking.sdkconfig", "trackingConfig");
      if (str != null)
        return e.a(new ByteArrayInputStream(str.getBytes())); 
    } catch (Exception exception) {}
    return null;
  }
  ...
  public static g b(Context paramContext, String paramString) {
    if (c(paramContext)) {
      g g1 = c(paramContext, paramString);
      if (g1 != null && g1.b != null && g1.b.size() > 0)
        return g1; 
    } 
    return null;
  }
  
  public static g c(Context paramContext, String paramString) {
    g g1;
    ...
    if (str2 != null)
      try {
        g g3 = e.a(new ByteArrayInputStream(str2.getBytes("UTF-8")));
        g1 = g3;
        if (g3 != null) {
          g1 = g3;
          g2 = g3;
          if (g3.b != null) {
            ...
            if (g3.b.size() > 0) {
              g2 = g3;
              d.a(paramContext, "cn.com.mma.mobile.tracking.other", "updateTime", System.currentTimeMillis());
              g2 = g3;
              d.a(paramContext, "cn.com.mma.mobile.tracking.sdkconfig", "trackingConfig", str2);
              g2 = g3;
              a.a("mma_网络更新sdkconfig.xml成功");
              g1 = g3;
            } 
          } 
        } 
  ...
  private static boolean c(Context paramContext) {
    ...
    long l2 = d.b(paramContext, "cn.com.mma.mobile.tracking.other", "updateTime");
    StringBuilder stringBuilder2 = new StringBuilder();
    stringBuilder2.append("mma_config lastUpdateTimeStamp:");
    stringBuilder2.append(l2);
    a.a(stringBuilder2.toString());
    boolean bool = a.a(paramContext);
    boolean bool3 = true;
    if (bool && l1 - l2 >= 7200000L) {
      bool1 = true;
    } else {
      bool1 = false;
    } 
    if (a.b(paramContext) && l1 - l2 >= 21600000L) {
      bool2 = true;
    } else {
      bool2 = false;
    } 
    ...
    stringBuilder1.append("mma_config File need Update：");
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued9136188-dex2jar.jar!\com\tencent\ams\a\a\c\c.class
