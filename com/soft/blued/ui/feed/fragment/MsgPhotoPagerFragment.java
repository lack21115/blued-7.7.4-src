...
public class MsgPhotoPagerFragment extends BaseFragment implements EventCallBackListener {
  ...
  private List<ChildImageInfo> v = new ArrayList<ChildImageInfo>();
  ...
  public static void a(BaseFragment paramBaseFragment, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2) {
    ...
    TerminalActivity.a((Fragment)paramBaseFragment, MsgPhotoPagerFragment.class, bundle, 1);
  }
  
  private void b(int paramInt) {
    ChildImageInfo childImageInfo = ChildPhotoManager.a().a(paramInt);
  ...
  private void k() {
    ...
    if (bundle != null) {
      ...
      this.u = bundle.getBoolean("photo_destroy_switch", false);
      this.w = bundle.getBoolean("photo_from_group", false);
    } 
    this.v.addAll(ChildPhotoManager.a().c());
  }
  ...
  private void l() {
    ...
    this.k.setOnClickListener(new View.OnClickListener(this) {
          public void onClick(View param1View) {
            MsgPhotoPagerFragment.c(this.a).setChecked(MsgPhotoPagerFragment.c(this.a).isChecked() ^ true);
          }
        });
    if (this.w) {
      this.k.setVisibility(8);
    ...
    this.l.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(this) {
          public void onCheckedChanged(CompoundButton param1CompoundButton, boolean param1Boolean) {
            if (MsgPhotoPagerFragment.d(this.a)) {
    ...
    this.p.setOnClickListener(new View.OnClickListener(this) {
          public void onClick(View param1View) {
            ChildImageInfo childImageInfo = ChildPhotoManager.a().a(MsgPhotoPagerFragment.a(this.a));
            if (childImageInfo.mSelect) {
              childImageInfo.mSelect = false;
              MsgPhotoPagerFragment.e(this.a).setImageResource(2131233518);
              SelectPhotoManager.a().b(childImageInfo);
              MsgPhotoPagerFragment.f(this.a).b(childImageInfo);
              MsgPhotoPagerFragment.g(this.a);
              return;
            } 
            if (SelectPhotoManager.a().b() < PhotoConstants.CONFIG.a) {
              childImageInfo.mSelect = true;
              MsgPhotoPagerFragment.e(this.a).setImageResource(2131233514);
              SelectPhotoManager.a().a(childImageInfo);
              MsgPhotoPagerFragment.g(this.a);
              MsgPhotoPagerFragment.f(this.a).a(childImageInfo);
              return;
            } 
    ...
    this.o.setOnClickListener(new View.OnClickListener(this) {
          public void onClick(View param1View) {
            MsgPhotoPagerFragment.h(this.a);
          }
        });
    this.f.setOnPageChangeListener(new ViewPager.OnPageChangeListener(this) {
          ...
          public void onPageSelected(int param1Int) {
            MsgPhotoPagerFragment.a(this.a, param1Int);
            MsgPhotoPagerFragment msgPhotoPagerFragment = this.a;
            MsgPhotoPagerFragment.b(msgPhotoPagerFragment, MsgPhotoPagerFragment.a(msgPhotoPagerFragment));
            MsgPhotoPagerFragment.f(this.a).c(MsgPhotoPagerFragment.b(this.a).get(MsgPhotoPagerFragment.a(this.a)));
          }
        });
    b(this.t);
  ...
  private void m() {
    ...
    ChildImageInfo childImageInfo = ChildPhotoManager.a().a(this.t);
    ...
    this.r.a(new MsgAblumAdapter.OnItemClickListener(this) {
          public void a(ChildImageInfo param1ChildImageInfo) {
            for (int i = 0; i < MsgPhotoPagerFragment.b(this.a).size(); i++) {
              if (TextUtils.equals(((ChildImageInfo)MsgPhotoPagerFragment.b(this.a).get(i)).mImagePath, param1ChildImageInfo.mImagePath)) {
                MsgPhotoPagerFragment.a(this.a, i);
                MsgPhotoPagerFragment.i(this.a).setCurrentItem(MsgPhotoPagerFragment.a(this.a), false);
                MsgPhotoPagerFragment.g(this.a);
                return;
              } 
            } 
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent) {
    if (paramInt2 == -1 && paramInt1 == 1000 && paramIntent != null && paramIntent.getBooleanExtra("close_page", false)) {
  ...
  class ImagePagerAdapter extends FragmentStatePagerAdapter {
    public ImagePagerAdapter(MsgPhotoPagerFragment this$0, FragmentManager param1FragmentManager) {
    ...
    public int getCount() {
      return MsgPhotoPagerFragment.b(this.a).size();
    }
    
    public Fragment getItem(int param1Int) {
      VideoPlayConfig videoPlayConfig;
      if (!TextUtils.isEmpty(((ChildImageInfo)MsgPhotoPagerFragment.b(this.a).get(param1Int)).imgUri)) {
        String str = ((ChildImageInfo)MsgPhotoPagerFragment.b(this.a).get(param1Int)).imgUri;
      } else {
        String str = ((ChildImageInfo)MsgPhotoPagerFragment.b(this.a).get(param1Int)).mImagePath;
      } 
      if (LocalMediaLoader.MediaType.a(((ChildImageInfo)MsgPhotoPagerFragment.b(this.a).get(param1Int)).mediaType)) {
        videoPlayConfig = new VideoPlayConfig();
        videoPlayConfig.a = ((ChildImageInfo)MsgPhotoPagerFragment.b(this.a).get(param1Int)).mImagePath;
        videoPlayConfig.b = ((ChildImageInfo)MsgPhotoPagerFragment.b(this.a).get(param1Int)).mImagePath;
        videoPlayConfig.w = new MediaInfo();
        ...
        videoPlayConfig.w.height = ((ChildImageInfo)MsgPhotoPagerFragment.b(this.a).get(param1Int)).height;
        videoPlayConfig.w.width = ((ChildImageInfo)MsgPhotoPagerFragment.b(this.a).get(param1Int)).width;
        videoPlayConfig.w.path = ((ChildImageInfo)MsgPhotoPagerFragment.b(this.a).get(param1Int)).mImagePath;
        videoPlayConfig.w.videoTime = ((ChildImageInfo)MsgPhotoPagerFragment.b(this.a).get(param1Int)).duration;
        videoPlayConfig.w.media_type = 3;
        return (Fragment)VideoDetailFragment.a(videoPlayConfig);
      } 
      return (Fragment)ImageDetailFragment.a((String)videoPlayConfig, true, 4, null, param1Int, MsgPhotoPagerFragment.b(this.a).size());
    }
  }
}


/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued9136188-dex2jar.jar!\com\soft\blue\\ui\feed\fragment\MsgPhotoPagerFragment.class
