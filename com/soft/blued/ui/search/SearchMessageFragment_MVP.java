...
public final class SearchMessageFragment_MVP implements MvpDispatcher {
  private void a(SearchMessageFragment paramSearchMessageFragment, String paramString) {
    // Byte code:
    //   0: aload_2
    ...
    //   84: return
    //   85: aload_1
    //   86: invokevirtual m : ()V
    //   89: return
    //   90: aload_1
    //   91: invokevirtual l : ()V
    //   94: return
    //   95: aload_1
    //   96: invokevirtual k : ()V
    //   99: return
  }
  ...
  public void a(MvpFragment paramMvpFragment, String paramString, List<Object> paramList) {
    ...
    if (paramList != null && paramList.size() > 0) {
      ...
      if (object != null) {
        if (paramString.hashCode() != 1060515318 || !paramString.equals("MESSAGE_LIST"))
          b = -1; 
    ...
    a((SearchMessageFragment)paramMvpFragment, paramString);
  }
}


/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued9136188-dex2jar.jar!\com\soft\blue\\ui\search\SearchMessageFragment_MVP.class
