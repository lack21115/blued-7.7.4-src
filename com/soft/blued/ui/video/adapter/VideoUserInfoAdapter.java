...
public class VideoUserInfoAdapter extends RecyclerView.Adapter<VideoUserInfoAdapter.ViewHolder> {
  ...
  RecyclerView.OnScrollListener e = new RecyclerView.OnScrollListener(this) {
      public void onScrollStateChanged(RecyclerView param1RecyclerView, int param1Int) {
        ...
        VideoUserInfoAdapter.c(this.a, true);
        RecyclerView.LayoutManager layoutManager = param1RecyclerView.getLayoutManager();
        if (param1Int != 0) {
          if (param1Int != 1)
            return; 
          boolean bool = UserInfoVideoDataManager.a().f();
          if (!bool) {
            Logger.b("VideoScanAdapter", new Object[] { "no more data" });
            return;
          } 
          if (layoutManager instanceof LinearLayoutManager && ((LinearLayoutManager)layoutManager).findLastVisibleItemPosition() > VideoUserInfoAdapter.k(this.a).size() - 5 && bool) {
            ...
            if (UserInfoVideoDataManager.a().e()) {
              ...
              Log.v("drb", "满足列表下载条件");
              InstantLog.a(1, 1);
              UserInfoVideoDataManager.a().b((IRequestHost)VideoUserInfoAdapter.e(this.a).w_());
              return;
            } 
          } 
        } else {
          VideoUserInfoAdapter.c(this.a, false);
          if (layoutManager == null)
            return; 
          View view = this.a.a.findSnapView(layoutManager);
          if (VideoUserInfoAdapter.b(this.a) == null)
            VideoUserInfoAdapter.a(this.a, view); 
          if (VideoUserInfoAdapter.b(this.a) != null) {
            if (view == null)
              return; 
            VideoUserInfoAdapter.ViewHolder viewHolder2 = (VideoUserInfoAdapter.ViewHolder)VideoUserInfoAdapter.d(this.a).getChildViewHolder(VideoUserInfoAdapter.b(this.a));
            VideoUserInfoAdapter.ViewHolder viewHolder1 = (VideoUserInfoAdapter.ViewHolder)VideoUserInfoAdapter.d(this.a).getChildViewHolder(view);
            PLVideoPageView pLVideoPageView2 = VideoUserInfoAdapter.ViewHolder.a(viewHolder2);
            PLVideoPageView pLVideoPageView1 = VideoUserInfoAdapter.ViewHolder.a(viewHolder1);
            if (!TextUtils.equals(pLVideoPageView2.getVideoUrl(), pLVideoPageView1.getVideoUrl()) || VideoUserInfoAdapter.b(this.a) != view) {
              Logger.b("VideoScanAdapter", new Object[] { "onPageChange" });
              InstantLog.a("shine_video_detail_show");
              pLVideoPageView2.j();
              VideoUserInfoAdapter.ViewHolder.i(viewHolder2).setVisibility(8);
              VideoUserInfoAdapter videoUserInfoAdapter = this.a;
              videoUserInfoAdapter.b = false;
              VideoUserInfoAdapter.a(videoUserInfoAdapter, view);
              VideoUserInfoAdapter.a(this.a, ((Integer)pLVideoPageView1.getTag(2131299508)).intValue());
              UserInfoVideoDataManager.a().a(VideoUserInfoAdapter.l(this.a));
              pLVideoPageView1.setOnPLVideoListener(viewHolder1);
              pLVideoPageView1.c();
              if (VideoUserInfoAdapter.g(this.a) != null)
                VideoUserInfoAdapter.g(this.a).a(pLVideoPageView1); 
            } 
          } 
        } 
      }
  ...
  private VideoUserInfoFragment k;
  ...
  public VideoUserInfoAdapter(Context paramContext, IRequestHost paramIRequestHost, VideoUserInfoFragment paramVideoUserInfoFragment, RecyclerView paramRecyclerView, int paramInt) {
    this.f = paramContext;
    this.g = paramIRequestHost;
    this.c = paramInt;
    this.d = new CoordinateConverter(this.f);
    this.k = paramVideoUserInfoFragment;
  ...
  private void a(BluedIngSelfFeed paramBluedIngSelfFeed, PLVideoPageView paramPLVideoPageView, View.OnClickListener paramOnClickListener) {
    if (paramBluedIngSelfFeed.is_repost == 1 && paramBluedIngSelfFeed.repost != null) {
      b(paramBluedIngSelfFeed.repost, paramPLVideoPageView, paramOnClickListener);
      return;
    } 
    b(paramBluedIngSelfFeed, paramPLVideoPageView, paramOnClickListener);
  }
  
  private void b(BluedIngSelfFeed paramBluedIngSelfFeed, PLVideoPageView paramPLVideoPageView, View.OnClickListener paramOnClickListener) {
    boolean bool1;
    boolean bool2;
  ...
  private void f() {
    ...
    this.i.addOnItemTouchListener((RecyclerView.OnItemTouchListener)new RecyclerView.SimpleOnItemTouchListener(this) {
          public boolean onInterceptTouchEvent(RecyclerView param1RecyclerView, MotionEvent param1MotionEvent) {
            return VideoUserInfoAdapter.a(this.a).onTouchEvent(param1MotionEvent);
          }
        });
    this.n = new GestureDetector(this.f, (GestureDetector.OnGestureListener)new GestureDetector.SimpleOnGestureListener(this) {
          public boolean onDoubleTap(MotionEvent param1MotionEvent) {
            if (VideoUserInfoAdapter.b(this.a) != null && !VideoUserInfoAdapter.c(this.a))
              VideoUserInfoAdapter.ViewHolder.a((VideoUserInfoAdapter.ViewHolder)VideoUserInfoAdapter.d(this.a).getChildViewHolder(VideoUserInfoAdapter.b(this.a)), false); 
            return false;
          }
          
          public boolean onDown(MotionEvent param1MotionEvent) {
            VideoUserInfoAdapter.a(this.a, false);
            return false;
          }
          ...
          public void onLongPress(MotionEvent param1MotionEvent) {
            ...
            if (VideoUserInfoAdapter.b(this.a) != null && !VideoUserInfoAdapter.c(this.a) && !(VideoUserInfoAdapter.e(this.a)).s)
              VideoUserInfoAdapter.ViewHolder.b((VideoUserInfoAdapter.ViewHolder)VideoUserInfoAdapter.d(this.a).getChildViewHolder(VideoUserInfoAdapter.b(this.a))); 
          ...
          public boolean onSingleTapConfirmed(MotionEvent param1MotionEvent) {
            ...
            if (VideoUserInfoAdapter.b(this.a) != null && !VideoUserInfoAdapter.c(this.a))
              VideoUserInfoAdapter.ViewHolder.a((VideoUserInfoAdapter.ViewHolder)VideoUserInfoAdapter.d(this.a).getChildViewHolder(VideoUserInfoAdapter.b(this.a))).d(); 
            return false;
          }
        });
  }
  ...
  public void a() {
    null = UserInfoVideoDataManager.a().b();
    if (null == null)
      return; 
    synchronized (this.h) {
  ...
  public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, PLVideoPageView.OnPLVideoListener {
    ...
    private View.OnClickListener am = new View.OnClickListener(this) {
        public void onClick(View param2View) {
          if (VideoUserInfoAdapter.ViewHolder.a(this.a).getTotalTime() <= 60000L)
            return; 
          AppInfo.n().removeCallbacks(this.a.q);
          if (VideoUserInfoAdapter.ViewHolder.a(this.a).a()) {
            VideoUserInfoAdapter.ViewHolder.e(this.a).setVisibility(8);
            VideoUserInfoAdapter.ViewHolder.f(this.a).setVisibility(8);
            VideoUserInfoAdapter.ViewHolder.d(this.a).setThumb(null);
            VideoUserInfoAdapter.ViewHolder.d(this.a).setOnSeekBarChangeListener(null);
            return;
          } 
          VideoUserInfoAdapter.ViewHolder.e(this.a).setVisibility(0);
          VideoUserInfoAdapter.ViewHolder.f(this.a).setVisibility(0);
          VideoUserInfoAdapter.ViewHolder.d(this.a).setThumb(VideoUserInfoAdapter.f(this.a.s).getResources().getDrawable(2131234074));
          VideoUserInfoAdapter.ViewHolder.d(this.a).setThumbOffset(0);
          VideoUserInfoAdapter.ViewHolder.d(this.a).setOnSeekBarChangeListener(this.a.r);
          if (VideoUserInfoAdapter.ViewHolder.d(this.a).getThumb() instanceof AnimationDrawable)
            ((AnimationDrawable)VideoUserInfoAdapter.ViewHolder.d(this.a).getThumb()).start(); 
          VideoUserInfoAdapter.ViewHolder.g(this.a);
        }
      };
    ...
    SeekBar.OnSeekBarChangeListener r = new SeekBar.OnSeekBarChangeListener(this) {
        ...
        public void onStopTrackingTouch(SeekBar param2SeekBar) {
          ...
          this.a.e(param2SeekBar.getProgress());
        }
      };
    ...
    public ViewHolder(VideoUserInfoAdapter this$0, View param1View) {
      super(param1View);
      this.t = param1View;
      ...
      int i = StatusBarHelper.a(VideoUserInfoAdapter.f(this$0));
    ...
    private void A() {
      FeedHttpUtils.a(VideoUserInfoAdapter.f(this.s), new BluedUIHttpResponse<BluedEntity>(this) {
            ...
            public void onUIUpdate(BluedEntity param2BluedEntity) {
              (VideoUserInfoAdapter.ViewHolder.c(this.a)).iliked = 1;
              LiveEventBus.get("feed_like_change").post(VideoUserInfoAdapter.ViewHolder.c(this.a));
              UserInfoDataObserver.a().c();
            }
          }UserInfo.a().i().getUid(), this.al.feed_id, 0, "", (IRequestHost)VideoUserInfoAdapter.e(this.s).w_());
    }
    ...
    private void B() {
      FeedHttpUtils.a(VideoUserInfoAdapter.f(this.s), new BluedUIHttpResponse<BluedEntity>(this) {
            ...
            public void onUIUpdate(BluedEntity param2BluedEntity) {
              (VideoUserInfoAdapter.ViewHolder.c(this.a)).iliked = 0;
              LiveEventBus.get("feed_like_change").post(VideoUserInfoAdapter.ViewHolder.c(this.a));
              UserInfoDataObserver.a().c();
            }
          }UserInfo.a().i().getUid(), this.al.feed_id, this.al.is_ads, (IRequestHost)VideoUserInfoAdapter.e(this.s).w_());
    }
    ...
    private void C() {
      ...
      //   13: aload_0
      //   14: getfield s : Lcom/soft/blued/ui/video/adapter/VideoUserInfoAdapter;
      //   17: invokestatic f : (Lcom/soft/blued/ui/video/adapter/VideoUserInfoAdapter;)Landroid/content/Context;
      //   20: new com/soft/blued/ui/video/adapter/VideoUserInfoAdapter$ViewHolder$9
      //   23: dup
      //   24: aload_0
      //   25: invokespecial <init> : (Lcom/soft/blued/ui/video/adapter/VideoUserInfoAdapter$ViewHolder;)V
      //   28: aload_0
      //   29: getfield al : Lcom/soft/blued/ui/feed/model/BluedIngSelfFeed;
      //   32: getfield feed_uid : Ljava/lang/String;
      //   35: ldc_w ''
      //   38: aload_0
      //   39: getfield s : Lcom/soft/blued/ui/video/adapter/VideoUserInfoAdapter;
      //   42: invokestatic e : (Lcom/soft/blued/ui/video/adapter/VideoUserInfoAdapter;)Lcom/soft/blued/ui/video/fragment/VideoUserInfoFragment;
    ...
    private void D() {
      ...
      valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
            public void onAnimationUpdate(ValueAnimator param2ValueAnimator) {
              ...
              VideoUserInfoAdapter.ViewHolder.i(this.a).setAlpha(f);
            }
          });
      valueAnimator.start();
    }
    ...
    private void E() {
      ...
      ImageFileLoader.a(null).b(this.al.user_avatar).a(new ImageFileLoader.OnLoadFileListener(this) {
            public void onUIFinish(File param2File, Exception param2Exception) {
              ...
              ShareUtils.a().a(VideoUserInfoAdapter.f(this.a.s), (View)VideoUserInfoAdapter.ViewHolder.a(this.a), null, (Bitmap)param2File, VideoUserInfoAdapter.ViewHolder.c(this.a), "shine_video_list_detail", false, 5, "", -1, 8);
            }
          }).a();
    }
    ...
    private void c(BluedIngSelfFeed param1BluedIngSelfFeed) {
      ...
      if (param1BluedIngSelfFeed == null)
        return; 
      VideoUserInfoFragment videoUserInfoFragment = VideoUserInfoAdapter.e(this.s);
      StringBuilder stringBuilder = null;
      if (videoUserInfoFragment == null) {
        videoUserInfoFragment = null;
      } else {
        activityFragmentActive = VideoUserInfoAdapter.e(this.s).w_();
      } 
      ...
      if (j > 0) {
        ...
        Animation animation = AnimationUtils.loadAnimation(VideoUserInfoAdapter.f(this.s), 2130771996);
      ...
      UserRelationshipUtils.a(VideoUserInfoAdapter.f(this.s), this.y, userBasicModel, 2131100528);
      ...
      this.B.setText(AreaUtils.a(VideoUserInfoAdapter.f(this.s), Integer.toString(param1BluedIngSelfFeed.feed_dig)));
      this.C.setText(AreaUtils.a(VideoUserInfoAdapter.f(this.s), Integer.toString(param1BluedIngSelfFeed.feed_comment)));
      this.D.setText(AreaUtils.a(VideoUserInfoAdapter.f(this.s), Integer.toString(param1BluedIngSelfFeed.repost_count)));
      ...
      if (d(param1BluedIngSelfFeed)) {
        ...
        if (VideoUserInfoAdapter.e(this.s) == null) {
          stringBuilder1 = stringBuilder;
        } else {
          activityFragmentActive1 = VideoUserInfoAdapter.e(this.s).w_();
        } 
    ...
    private void x() {
      ...
      VideoUserInfoAdapter.b(this.s, false);
    }
    ...
    private void y() {
      ...
      this.p.a((IRequestHost)VideoUserInfoAdapter.e(this.s).w_(), "", str, "", "", (LiveAnimationListener)new AnimationListenerAdapter(this) {
            public void b() {}
          });
    }
    ...
    private void z() {
      ...
      if (!UserRelationshipUtils.a(this.al.relationship)) {
        if (!this.ae) {
          ...
          FeedDetailsFragment.a(VideoUserInfoAdapter.f(this.s), this.al, 8, 7, false);
        } 
        this.t.postDelayed(new Runnable(this) {
              public void run() {
                VideoUserInfoAdapter.ViewHolder.b(this.a, false);
              }
            }500L);
      } 
    }
    ...
    public void a(long param1Long1, long param1Long2) {
      long l1;
      if (VideoUserInfoAdapter.i(this.s))
        return; 
      if (param1Long2 > 0L) {
      ...
      if (this.aj.getThumb() instanceof AnimationDrawable) {
        ...
        if (videoLoadingView != null && videoLoadingView.getVisibility() == 0)
          x(); 
        this.aj.setThumb(VideoUserInfoAdapter.f(this.s).getResources().getDrawable(2131234075));
        this.aj.setThumbOffset(0);
        this.aj.setOnSeekBarChangeListener(this.r);
        Logger.b("xpf", new Object[] { "---------------------" });
      } 
      String str = VideoUserInfoAdapter.j(this.s).format(new Date(l2));
      this.ah.setText(str);
      str = VideoUserInfoAdapter.j(this.s).format(new Date(param1Long2));
      this.ai.setText(str);
      if (param1Long2 > 60000L) {
        if (this.A.getVisibility() == 8) {
          this.A.setVisibility(0);
          this.A.setText(VideoUserInfoAdapter.f(this.s).getResources().getString(2131758777));
          return;
        } 
      } else {
    ...
    public void a(long param1Long1, long param1Long2, int param1Int) {
      if (this.u.getTotalTime() <= 60000L)
        return; 
      VideoUserInfoAdapter.b(this.s, true);
      AppInfo.n().removeCallbacks(this.q);
      String str = VideoUserInfoAdapter.j(this.s).format(new Date(param1Long1));
      this.ah.setText(str);
      str = VideoUserInfoAdapter.j(this.s).format(new Date(param1Long2));
      this.ai.setText(str);
    ...
    public void a(BluedIngSelfFeed param1BluedIngSelfFeed, int param1Int) {
      ...
      VideoUserInfoAdapter.a(this.s, this.al, this.u, this.am);
      this.u.setTag(2131299508, Integer.valueOf(param1Int));
      this.u.setTag(2131299224, this.al);
      if (this.al.feed_videos != null)
        if (VideoUserInfoAdapter.b(this.s) == null) {
          if (UserInfoVideoDataManager.a().g() == param1Int) {
            InstantLog.a("shine_video_detail_show");
            this.u.c();
            VideoUserInfoAdapter.a(this.s, this.t);
            VideoUserInfoAdapter.a(this.s, param1Int);
            if (VideoUserInfoAdapter.g(this.s) != null)
              VideoUserInfoAdapter.g(this.s).a(this.u); 
            String str = c(param1Int);
            if (!StringUtils.e(str)) {
              Logger.a("pre_video", str);
              this.u.a(str);
            } 
          } 
        } else if (VideoUserInfoAdapter.b(this.s) == this.t) {
          this.u.c();
          if (VideoUserInfoAdapter.g(this.s) != null)
            VideoUserInfoAdapter.g(this.s).a(this.u); 
        }  
    ...
    public String c(int param1Int) {
      if (++param1Int < UserInfoVideoDataManager.a().b().size()) {
        BluedIngSelfFeed bluedIngSelfFeed = UserInfoVideoDataManager.a().b().get(param1Int);
    ...
    public void c() {
      if (this.Y != null && d(this.al)) {
        Animation animation = AnimationUtils.loadAnimation(VideoUserInfoAdapter.f(this.s), 2130771998);
        animation.setInterpolator((Interpolator)new LinearInterpolator());
        this.Z.startAnimation(animation);
        this.ac.setVisibility(0);
        ImageLoader.c(VideoUserInfoAdapter.h(this.s), "video_scan_music_anim.png").e(-1).f().a(this.ac);
        this.X.setLines(1);
    ...
    public void g_(int param1Int) {
      VideoUserInfoAdapter.e(this.s).e(param1Int);
    }
    
    public void onClick(View param1View) {
      VideoUserInfoAdapter.a(this.s, true);
      ...
      switch (i) {
        ...
        case 2131300703:
          if (this.G.a() && !LinkMovementClickMethod.a().b()) {
            VideoUserInfoAdapter.e(this.s).w();
            return;
          } 
          return;
        case 2131300649:
          InstantLog.b(5, this.al, "", -1);
          VideoUserInfoAdapter.e(this.s).u();
          return;
        case 2131298020:
        ...
        case 2131298019:
          ...
          UserInfoVideoDataManager.a().c(this.al);
          return;
        case 2131298016:
        case 2131298017:
          MusicVideoCollectFragment.a(VideoUserInfoAdapter.f(this.s), this.al.music);
          return;
        case 2131298015:
          z();
          return;
        case 2131298014:
          ...
          if (b(this.al)) {
            ShowPositionActivity.a(VideoUserInfoAdapter.f(this.s), this.al.location_lot, this.al.location_lat, this.al.location, 1);
            return;
          } 
          return;
        case 2131298011:
        ...
        case 2131298008:
          ...
          return;
        case 2131298005:
          VideoUserInfoAdapter.e(this.s).v();
          return;
        case 2131297556:
          ...
          FeedPostFragment.a(VideoUserInfoAdapter.f(this.s));
          return;
        case 2131297436:
          VideoUserInfoAdapter.e(this.s).t();
          return;
        case 2131297431:
          C();
          return;
      ...
      if (this.al.live > 0) {
        UserRelationshipUtils.a(VideoUserInfoAdapter.f(this.s), userBasicModel, this.al.live, "flash_detail_live");
      } else {
        UserInfoFragmentNew.a(VideoUserInfoAdapter.f(this.s), userBasicModel, "shine_video_detail", (View)this.v, null, new MsgSourceEntity(MessageProtos.StrangerSource.FIND_PLAZA_FLASH_DETAIL, EncryptTool.b(this.al.feed_id)));
      } 
      LogData logData = new LogData();
  ...
  class null implements View.OnClickListener {
    null(VideoUserInfoAdapter this$0) {}
  ...
  class null implements ImageFileLoader.OnLoadFileListener {
    ...
    public void onUIFinish(File param1File, Exception param1Exception) {
      ...
      ShareUtils.a().a(VideoUserInfoAdapter.f(this.a.s), (View)VideoUserInfoAdapter.ViewHolder.a(this.a), null, (Bitmap)param1File, VideoUserInfoAdapter.ViewHolder.c(this.a), "shine_video_list_detail", false, 5, "", -1, 8);
    }
  }
  ...
  class null implements SeekBar.OnSeekBarChangeListener {
    ...
    public void onStopTrackingTouch(SeekBar param1SeekBar) {
      Logger.c("VideoScanAdapter", new Object[] { "onStopTrackingTouch" });
      this.a.e(param1SeekBar.getProgress());
    }
  }
  ...
  class null implements UserRelationshipUtils.IAddOrRemoveAttentionDone {
    ...
    public void a() {
      DialogUtils.a((VideoUserInfoAdapter.e(this.a.s)).q);
    }
    
    public void a(String param1String) {
      if ("1".equalsIgnoreCase(param1String) || "3".equalsIgnoreCase(param1String)) {
        VideoUserInfoAdapter.ViewHolder.h(this.a).setImageResource(2131234143);
        AppInfo.n().postDelayed(new Runnable(this) {
              public void run() {
                VideoUserInfoAdapter.ViewHolder.h(this.a.a).setVisibility(8);
              }
            },  1000L);
      } else {
        VideoUserInfoAdapter.ViewHolder.h(this.a).setImageResource(2131234142);
      } 
      (VideoUserInfoAdapter.ViewHolder.c(this.a)).relationship = param1String;
      UserInfoVideoDataManager.a().a((VideoUserInfoAdapter.ViewHolder.c(this.a)).feed_id, (VideoUserInfoAdapter.ViewHolder.c(this.a)).relationship);
      UserInfoDataObserver.a().c();
    }
    
    public void b() {
      DialogUtils.b((VideoUserInfoAdapter.e(this.a.s)).q);
    }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued9136188-dex2jar.jar!\com\soft\blue\\ui\video\adapter\VideoUserInfoAdapter.class
