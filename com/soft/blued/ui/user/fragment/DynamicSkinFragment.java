...
public class DynamicSkinFragment extends CustomSettingBaseFragment {
  ...
  public static void a(Context paramContext, int paramInt, String paramString) {
    ...
    TerminalActivity.d(paramContext, DynamicSkinFragment.class, bundle);
  }
  ...
  public void a(int paramInt) {
    EventTrackFeed.a(FeedProtos.Event.FEED_DYNAMIC_SKIN_SAVE_CLICK, paramInt);
  }
  ...
  public void a(VIPCustomSettingBase paramVIPCustomSettingBase) {
    ...
    ImageLoader.a((IRequestHost)w_(), DynamicSkinManager.a().a(paramVIPCustomSettingBase.id)).a(this.p);
  }
  
  public void b(int paramInt) {
    AppMethods.d(2131756225);
    DynamicSkinManager.a().b(paramInt);
    this.o.setVisibility(8);
    this.n.setVisibility(8);
  }
  ...
  public String l() {
    return this.d.getResources().getString(2131756224);
  }
  ...
  public void onViewCreated(View paramView, Bundle paramBundle) {
    ...
    this.p = (ImageView)this.e.findViewById(2131297038);
    this.s = (TextView)this.e.findViewById(2131299358);
    this.t = (TextView)this.e.findViewById(2131300267);
    this.r = (ImageView)this.e.findViewById(2131297362);
    this.o = (TextView)this.e.findViewById(2131301583);
    this.u = (TextView)this.e.findViewById(2131301389);
    this.v = (TextView)this.e.findViewById(2131300304);
    String str = AvatarUtils.a(1, UserInfo.a().i().getAvatar());
    ImageLoader.a((IRequestHost)w_(), str).a(2131234356).c(2131234356).c().a(this.r);
    this.s.setText((UserInfo.a().i()).name);
    this.t.setText(TimeAndDateUtils.a());
    if (p()) {
      this.o.setVisibility(8);
      this.n.setVisibility(8);
    } else {
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued9136188-dex2jar.jar!\com\soft\blue\\u\\user\fragment\DynamicSkinFragment.class
