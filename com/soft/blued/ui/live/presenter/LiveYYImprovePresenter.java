...
public class LiveYYImprovePresenter extends LiveBaseImprovePresenter {
  public void a(int paramInt, String paramString) {
    LiveHttpUtils.a(new BluedUIHttpResponse<BluedEntityA<LiveIDCardUploadResult>>(this, g(), paramInt) {
        ...
        }UserInfo.a().i().getUid(), paramInt, paramString, "1", g());
  }
  ...
  public void a(boolean paramBoolean) {
    LiveHttpUtils.c(new BluedUIHttpResponse<BluedEntityA<BluedLiveState>>(this, g(), paramBoolean) {
        ...
        }UserInfo.a().i().getUid(), "1", g());
  }
  
  public void b(int paramInt, String paramString) {
    LiveHttpUtils.b(new BluedUIHttpResponse(this, g(), paramInt) {
          public boolean onUIFailure(int param1Int, String param1String) {
            AppMethods.a(param1String);
            return true;
          }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued9136188-dex2jar.jar!\com\soft\blue\\ui\live\presenter\LiveYYImprovePresenter.class
