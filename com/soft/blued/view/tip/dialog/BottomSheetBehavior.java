...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
  ...
  private final ArrayList<BottomSheetCallback> L = new ArrayList<BottomSheetCallback>();
  ...
  private final ViewDragHelper.Callback P = new ViewDragHelper.Callback(this) {
  ...
  public BottomSheetBehavior(Context paramContext, AttributeSet paramAttributeSet) {
    ...
    this.w = paramContext.getResources().getDimensionPixelSize(2131165640);
    TypedArray typedArray = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.BottomSheetBehavior_Layout);
    this.x = typedArray.hasValue(11);
    boolean bool = typedArray.hasValue(1);
    if (bool) {
      a(paramContext, paramAttributeSet, bool, MaterialResources.a(paramContext, typedArray, 1));
    } else {
    ...
    if (typedValue != null && typedValue.data == -1) {
      ...
      a(typedArray.getDimensionPixelSize(7, -1));
    } 
    b(typedArray.getBoolean(6, false));
    e(typedArray.getBoolean(10, false));
    a(typedArray.getBoolean(4, true));
    c(typedArray.getBoolean(9, false));
    d(typedArray.getBoolean(2, true));
    c(typedArray.getInt(8, 0));
    a(typedArray.getFloat(5, 0.5F));
    typedValue = typedArray.peekValue(3);
    if (typedValue != null && typedValue.type == 16) {
      b(typedValue.data);
    } else {
      b(typedArray.getDimensionPixelOffset(3, 0));
    } 
    typedArray.recycle();
  ...
  private void a(Context paramContext, AttributeSet paramAttributeSet, boolean paramBoolean, ColorStateList paramColorStateList) {
    if (this.x) {
      this.B = ShapeAppearanceModel.a(paramContext, paramAttributeSet, 2130968706, 2131821194).a();
  ...
  private int e() {
    if (this.u)
      return Math.min(Math.max(this.v, this.k - this.j * 9 / 16), this.K); 
    if (!this.A) {
      int i = this.z;
      if (i > 0)
  ...
  private void g(boolean paramBoolean) {
    ...
    if (Build.VERSION.SDK_INT >= 16 && paramBoolean)
      if (this.O == null) {
        this.O = new HashMap<View, Integer>(j);
      } else {
        return;
      }  
    for (int i = 0; i < j; i++) {
      ...
      if (view != this.l.get())
        if (paramBoolean) {
          if (Build.VERSION.SDK_INT >= 16)
            this.O.put(view, Integer.valueOf(view.getImportantForAccessibility())); 
          if (this.r)
            ViewCompat.setImportantForAccessibility(view, 4); 
        } else if (this.r) {
          Map<View, Integer> map = this.O;
          if (map != null && map.containsKey(view))
            ViewCompat.setImportantForAccessibility(view, ((Integer)this.O.get(view)).intValue()); 
        }  
    } 
    if (!paramBoolean)
      this.O = null; 
  ...
  public void a(BottomSheetCallback paramBottomSheetCallback) {
    if (!this.L.contains(paramBottomSheetCallback))
      this.L.add(paramBottomSheetCallback); 
  }
  ...
  public void b(BottomSheetCallback paramBottomSheetCallback) {
    this.L.remove(paramBottomSheetCallback);
  }
  ...
  void e(int paramInt) {
    ...
    h(paramInt);
    while (i < this.L.size()) {
      ((BottomSheetCallback)this.L.get(i)).a(view, paramInt);
      i++;
    } 
    k();
  }
  ...
  void f(int paramInt) {
    ...
    if (view != null && !this.L.isEmpty()) {
      ...
      float f1 = f2 / f1;
      for (paramInt = 0; paramInt < this.L.size(); paramInt++)
        ((BottomSheetCallback)this.L.get(paramInt)).a(view, f1); 
    } 
  }
  ...
  public boolean onInterceptTouchEvent(CoordinatorLayout paramCoordinatorLayout, V paramV, MotionEvent paramMotionEvent) {
    ...
    if (i != 0) {
      ...
      if (this.h != 2) {
        ...
        if (weakReference1 != null && paramCoordinatorLayout.isPointInChildBounds((View)weakReference1, j, this.N)) {
          this.n = paramMotionEvent.getPointerId(paramMotionEvent.getActionIndex());
          this.o = true;
        } 
      } 
      if (this.n == -1 && !paramCoordinatorLayout.isPointInChildBounds((View)paramV, j, this.N)) {
        bool = true;
      } else {
        bool = false;
      } 
        ...
        if (!this.H) {
          ...
          if (this.h != 1) {
            ...
            if (!paramCoordinatorLayout.isPointInChildBounds(view, (int)paramMotionEvent.getX(), (int)paramMotionEvent.getY())) {
              ...
              if (this.i != null) {
                bool = bool1;
                if (Math.abs(this.N - paramMotionEvent.getY()) > this.i.getTouchSlop())
                  bool = true; 
              } 
            } 
          } 
  ...
  public boolean onLayoutChild(CoordinatorLayout paramCoordinatorLayout, V paramV, int paramInt) {
    ...
    if (this.l == null) {
      this.v = paramCoordinatorLayout.getResources().getDimensionPixelSize(2131165312);
      c((View)paramV);
    ...
    if (this.i == null)
      this.i = ViewDragHelper.create((ViewGroup)paramCoordinatorLayout, this.P); 
    int i = paramV.getTop();
    ...
    this.K = paramV.getHeight();
    this.b = Math.max(0, this.k - this.K);
    g();
    f();
    paramInt = this.h;
    if (paramInt == 3) {
  ...
  public boolean onTouchEvent(CoordinatorLayout paramCoordinatorLayout, V paramV, MotionEvent paramMotionEvent) {
    ...
    if (this.M == null)
      this.M = VelocityTracker.obtain(); 
    this.M.addMovement(paramMotionEvent);
    if (this.i != null && i == 2 && !this.H && Math.abs(this.N - paramMotionEvent.getY()) > this.i.getTouchSlop())
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued9136188-dex2jar.jar!\com\soft\blued\view\tip\dialog\BottomSheetBehavior.class
