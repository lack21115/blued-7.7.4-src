...
public class Logger {
  ...
  public static void a(String paramString, Object paramObject) {
    if (a)
      try {
        String str = AppInfo.f().toJson(paramObject);
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("ljx_");
        stringBuilder.append(paramString);
        c(stringBuilder.toString(), new Object[] { str });
        return;
      } catch (Exception exception) {
        c("ljx_", new Object[] { paramObject });
      }  
  }
  ...
  public static void c(String paramString, Object... paramVarArgs) {
    if (a)
      a(TYPE.c, paramString, paramVarArgs); 
  }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued9136188-dex2jar.jar!\com\soft\blue\\utils\Logger.class
