...
public class TabPageIndicatorWithDot extends HorizontalScrollView implements BluedSkinSupportable {
  ...
  public int j = 2131100838;
  
  public int k = -14803165;
  
  public int l = 2131100884;
  
  public int m = -16738064;
  
  public int n = 2131100884;
  ...
  public int v = -16119286;
  
  public int w = 2131100838;
  
  public int x = -9013642;
  
  public int y = 2131100844;
  ...
  public TabPageIndicatorWithDot(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    ...
    if (typedArray1.hasValue(7))
      this.R = typedArray1.getResourceId(7, this.R); 
    this.K = typedArray1.getDimensionPixelSize(16, this.K);
    this.s = typedArray1.getDimensionPixelSize(10, this.s);
    this.H = typedArray1.getBoolean(6, this.H);
    this.I = typedArray1.getDimensionPixelSize(5, this.I);
    this.r = typedArray1.getDimension(3, this.r);
    this.q = typedArray1.getDimension(4, this.q);
    Logger.a("radius", String.valueOf(this.r));
    typedArray1.recycle();
    this.i = new Paint();
    ...
    this.A = new LinearLayout.LayoutParams(0, DensityUtils.a(paramContext, 44.0F), 1.0F);
  ...
  private void a(int paramInt, String paramString) {
    ...
    ShapeHelper.d((ShapeHelper.ShapeView)shapeTextView, 2131100728);
    ShapeHelper.b((ShapeHelper.ShapeView)shapeTextView, 2131100837);
    ...
    qBadgeContainer.a("");
    qBadgeContainer.a(BluedSkinUtils.a(this.a, 2131100728), 1.0F, true);
    qBadgeContainer.b(BluedSkinUtils.a(this.a, 2131100538));
    List<QBadgeContainer> list1 = this.aa;
    if (list1 != null)
      list1.add(qBadgeContainer); 
    linearLayout.setOnClickListener(new -$$Lambda$TabPageIndicatorWithDot$QncBFgjyFwpj6Hp9Qh5YvAooRxM(this, paramInt));
  ...
  public void a() {
    ...
    this.v = BluedSkinUtils.a(this.a, 2131100838);
    this.w = 2131100838;
    this.k = BluedSkinUtils.a(this.a, 2131100838);
    this.j = 2131100838;
    this.x = BluedSkinUtils.a(this.a, 2131100844);
    this.y = 2131100844;
  }
  ...
  public void a(int paramInt1, int paramInt2) {
    ...
    if (list != null) {
      if (list.isEmpty())
        return; 
      if (paramInt1 > this.aa.size() - 1)
        return; 
      QBadgeContainer qBadgeContainer = this.aa.get(paramInt1);
      if (qBadgeContainer == null)
        return; 
      qBadgeContainer.a(paramInt2);
    } 
  }
  ...
  public TextView b(int paramInt) {
    List<TextView> list = this.V;
    return (list != null && paramInt >= 0 && paramInt < list.size()) ? this.V.get(paramInt) : null;
  }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued9136188-dex2jar.jar!\com\soft\blued\customview\TabPageIndicatorWithDot.class
