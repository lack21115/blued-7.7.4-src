...
public class as {
  ...
  private static final byte[] c = new byte[] { 91, -62 };
  ...
  static {
    a = String.format("AES/%s/PKCS7Padding", new Object[] { "ECB" });
    b = Base64.decode("4M3PpUC4Vu1uMp+Y0Mxd+vfc6v4ggJAINfgTlH74pis=", 0);
  }
  
  private static Cipher a() throws a {
    // Byte code:
    //   0: ldc com/qq/e/comm/plugin/util/as
    //   2: monitorenter
    //   3: getstatic com/qq/e/comm/plugin/util/as.d : Ljavax/crypto/Cipher;
    //   6: ifnull -> 16
    //   9: getstatic com/qq/e/comm/plugin/util/as.d : Ljavax/crypto/Cipher;
    //   12: astore_0
    //   13: goto -> 47
    //   16: getstatic com/qq/e/comm/plugin/util/as.a : Ljava/lang/String;
    ...
    //   40: aload_0
    //   41: putstatic com/qq/e/comm/plugin/util/as.d : Ljavax/crypto/Cipher;
    //   44: goto -> 9
    //   47: ldc com/qq/e/comm/plugin/util/as
    //   49: monitorexit
    //   50: aload_0
    //   51: areturn
    //   52: astore_0
    //   53: new com/qq/e/comm/plugin/util/as$a
    //   56: dup
    ...
    //   63: athrow
    //   64: astore_0
    //   65: ldc com/qq/e/comm/plugin/util/as
    //   67: monitorexit
    //   68: aload_0
    //   69: athrow
    // Exception table:
  ...
  public static byte[] a(byte[] paramArrayOfbyte) throws b {
    ...
    try {
      ...
      dataOutputStream.write(c(e(paramArrayOfbyte)));
  ...
  private static Cipher b() throws a {
    ...
    //   0: ldc com/qq/e/comm/plugin/util/as
    //   2: monitorenter
    //   3: getstatic com/qq/e/comm/plugin/util/as.e : Ljavax/crypto/Cipher;
    //   6: ifnull -> 16
    //   9: getstatic com/qq/e/comm/plugin/util/as.e : Ljavax/crypto/Cipher;
    //   12: astore_0
    //   13: goto -> 47
    //   16: getstatic com/qq/e/comm/plugin/util/as.a : Ljava/lang/String;
    //   19: invokestatic getInstance : (Ljava/lang/String;)Ljavax/crypto/Cipher;
    ...
    //   37: invokevirtual init : (ILjava/security/Key;)V
    //   40: aload_0
    //   41: putstatic com/qq/e/comm/plugin/util/as.e : Ljavax/crypto/Cipher;
    //   44: goto -> 9
    //   47: ldc com/qq/e/comm/plugin/util/as
    //   49: monitorexit
    //   50: aload_0
  ...
  public static byte[] b(byte[] paramArrayOfbyte) throws b {
    if (paramArrayOfbyte != null && paramArrayOfbyte.length >= 4)
      try {
        ...
        if (dataInputStream.read(arrayOfByte) >= 4 && c[0] == arrayOfByte[0]) {
          byte b1 = c[1];
          byte b2 = arrayOfByte[1];
          if (b1 == b2 && 1 == arrayOfByte[2] && 2 == arrayOfByte[3])
            return f(d(Arrays.copyOfRange(paramArrayOfbyte, 4, paramArrayOfbyte.length))); 
        } 
  ...
  private static byte[] e(byte[] paramArrayOfbyte) {
    return bl.a(paramArrayOfbyte);
  }
  
  private static byte[] f(byte[] paramArrayOfbyte) {
    return bl.b(paramArrayOfbyte);
  }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued9136188-dex2jar.jar!\com\qq\e\comm\plugi\\util\as.class
