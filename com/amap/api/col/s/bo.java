...
public final class bo {
  ...
  private static void b(Context paramContext, boolean paramBoolean) {
    SharedPreferences.Editor editor = ci.b(paramContext, "open_common");
    ci.a(editor, "a3", paramBoolean);
    ci.a(editor);
  }
  ...
  public final void a(Context paramContext) {
    if (this.a == null)
      this.a = new b((byte)0); 
    this.a.a(ci.a(paramContext, "open_common", "a3", true));
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\com\amap\api\col\s\bo.class
