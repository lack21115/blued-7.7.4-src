...
public final class cq implements Closeable {
  ...
  public cq(InputStream paramInputStream, Charset paramCharset) {
    this(paramInputStream, paramCharset, (byte)0);
  }
  
  private cq(InputStream paramInputStream, Charset paramCharset, byte paramByte) {
          ...
          if (i != this.f) {
            ...
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream(this, this.f - this.e + 80) {
                public final String toString() {
                  ...
                  try {
                    return new String(this.buf, 0, i, cq.a(this.a).name());
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\com\amap\api\col\s\cq.class
