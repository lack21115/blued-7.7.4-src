...
public final class cw extends SSLSocketFactory {
  ...
  public cw(Context paramContext, SSLContext paramSSLContext) {
    // Byte code:
    //   0: aload_0
    ...
    //   60: ldc 'myssl'
    //   62: ldc '<init2>'
    //   64: invokestatic c : (Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   67: aload_0
    ...
    //   87: ldc 'myssl'
    //   89: ldc '<init3>'
    //   91: invokestatic c : (Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   94: return
    //   95: astore_1
    //   96: aload_1
    //   97: ldc 'myssl'
    //   99: ldc '<init>'
    //   101: invokestatic c : (Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   104: aload_0
    ...
    //   131: ldc 'myssl'
    //   133: ldc '<init2>'
    //   135: invokestatic c : (Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   138: aload_0
    ...
    //   158: ldc 'myssl'
    //   160: ldc '<init3>'
    //   162: invokestatic c : (Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   165: return
    //   166: astore_1
    //   167: aload_0
    ...
    //   194: ldc 'myssl'
    //   196: ldc '<init2>'
    //   198: invokestatic c : (Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   201: aload_0
    ...
    //   223: ldc 'myssl'
    //   225: ldc '<init3>'
    //   227: invokestatic c : (Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    //   230: aload_1
    //   231: athrow
    // Exception table:
    //   from	to	target	type
  ...
  private void a(SSLSessionCache paramSSLSessionCache) {
    ...
    try {
      ...
      Field field = paramSSLSessionCache.getClass().getDeclaredField(bs.c("UbVNlc3Npb25DYWNoZQ"));
      field.setAccessible(true);
      Object object = field.get(paramSSLSessionCache);
      Method[] arrayOfMethod = sSLSessionContext.getClass().getMethods();
      String str = bs.c("Yc2V0UGVyc2lzdGVudENhY2hl");
      return;
    } finally {
      paramSSLSessionCache = null;
      cg.c((Throwable)paramSSLSessionCache, "myssl", "isc2");
    } 
  }
  ...
  public final Socket createSocket(String paramString, int paramInt) throws IOException, UnknownHostException {
    try {
      ...
      paramString = null;
      cg.c((Throwable)paramString, "myssl", "cs3");
    } 
    return null;
  }
  ...
  public final Socket createSocket(String paramString, int paramInt1, InetAddress paramInetAddress, int paramInt2) throws IOException, UnknownHostException {
    try {
      ...
      paramString = null;
      cg.c((Throwable)paramString, "myssl", "cs4");
    } 
    return null;
  }
  ...
  public final Socket createSocket(InetAddress paramInetAddress, int paramInt) throws IOException {
    try {
      ...
      cg.c((Throwable)paramInetAddress, "myssl", "cs5");
    } 
    return null;
  }
  ...
  public final Socket createSocket(InetAddress paramInetAddress1, int paramInt1, InetAddress paramInetAddress2, int paramInt2) throws IOException {
    try {
      ...
      cg.c((Throwable)paramInetAddress1, "myssl", "cs6");
    } 
    return null;
  }
  ...
  public final Socket createSocket(Socket paramSocket, String paramString, int paramInt, boolean paramBoolean) throws IOException {
    try {
      ...
      paramSocket = null;
      cg.c((Throwable)paramSocket, "myssl", "cs2");
    } 
    return null;
  }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\com\amap\api\col\s\cw.class
