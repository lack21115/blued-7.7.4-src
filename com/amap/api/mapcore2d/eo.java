...
public class eo implements Closeable {
  ...
  public eo(InputStream paramInputStream, int paramInt, Charset paramCharset) {
    if (paramInputStream != null && paramCharset != null) {
      if (paramInt >= 0) {
        if (paramCharset.equals(ep.a)) {
  ...
  public eo(InputStream paramInputStream, Charset paramCharset) {
          ...
          if (i != this.e) {
            ...
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream(this, this.e - this.d + 80) {
                public String toString() {
                  ...
                  try {
                    return new String(this.buf, 0, i, eo.a(this.a).name());
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\com\amap\api\mapcore2d\eo.class
