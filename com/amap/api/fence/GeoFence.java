...
public class GeoFence implements Parcelable {
  ...
  protected GeoFence(Parcel paramParcel) {
    ...
    if (i != 0) {
      this.h = new ArrayList<List<DPoint>>();
      for (int j = 0; j < i; j++)
  ...
  public boolean equals(Object<List<DPoint>> paramObject) {
    ...
    if (dPoint == null) {
      if (((GeoFence)paramObject).n != null)
        return false; 
    } else if (!dPoint.equals(((GeoFence)paramObject).n)) {
      return false;
    } 
    if (this.i != ((GeoFence)paramObject).i)
      return false; 
    List<List<DPoint>> list = this.h;
    paramObject = (Object<List<DPoint>>)((GeoFence)paramObject).h;
    if (list == null) {
      if (paramObject != null)
        return false; 
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\com\amap\api\fence\GeoFence.class
