...
class k {
  ...
  private void a(int paramInt1, int paramInt2, byte paramByte) {
    a a2 = new a(paramInt1, paramByte);
    a a1 = this.d;
    while (paramByte > 8) {
      paramByte = (byte)(paramByte - 8);
      paramInt1 = paramInt2 >>> paramByte & 0xFF;
      if (a1.a != null) {
        if (a1.a[paramInt1] == null)
          a1.a[paramInt1] = new a(); 
        a1 = a1.a[paramInt1];
        continue;
      } 
  ...
  void a(f paramf, d paramd) throws IOException {
    int j = 0;
    long l = 0L;
    int i = 0;
    while (j < paramf.g()) {
      int n = paramf.a(j) & 0xFF;
      int m = a[n];
      n = b[n];
      l = l << n | m;
      i += n;
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7575468-dex2jar.jar!\com\bytedance\sdk\a\b\a\e\k.class
