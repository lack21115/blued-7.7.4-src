...
public class d extends a {
  ...
  public d(Context paramContext, k paramk, String paramString, int paramInt) {
    super(paramContext, paramk, paramString, paramInt);
  }
  
  public e a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong1, long paramLong2, View paramView1, View paramView2) {
    int k;
    this.x = 1;
    this.y = 0;
    this.z = 0;
    ...
    int j = 1;
    e.a a1 = (new e.a()).e(paramInt1).d(paramInt2).c(paramInt3).b(paramInt4).b(paramLong1).a(paramLong2).b(arrayOfInt1).a(arrayOfInt2).c(ai.b(paramView1)).d(arrayOfInt3).f(this.x).g(this.y).h(this.z);
    if (h.c().b()) {
      paramInt1 = j;
    } else {
      paramInt1 = 2;
    } 
    return a1.a(paramInt1).a(this.B).a();
  }
