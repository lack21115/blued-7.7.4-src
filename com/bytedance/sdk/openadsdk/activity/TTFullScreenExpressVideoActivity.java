...
public class TTFullScreenExpressVideoActivity extends TTFullScreenVideoActivity implements TTNativeExpressAd.ExpressAdInteractionListener, g {
  ...
  String aJ = "fullscreen_interstitial_ad";
  ...
  protected void d() {
    ...
    t.e("TTFullScreenExpressVideoActivity", stringBuilder.toString());
  ...
  public void onRenderFail(View paramView, String paramString, int paramInt) {
    ...
    StringBuilder stringBuilder = new StringBuilder();
    stringBuilder.append("onRenderFail、、、code:");
    stringBuilder.append(paramInt);
    t.b("TTFullScreenExpressVideoActivity", stringBuilder.toString());
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7575468-dex2jar.jar!\com\bytedance\sdk\openadsdk\activity\TTFullScreenExpressVideoActivity.class
