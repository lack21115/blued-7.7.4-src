...
public class d {
  ...
  public static void a(String paramString1, int paramInt, String paramString2, String paramString3, String paramString4) {
    try {
      k k = c.a(new JSONObject(a));
      JSONObject jSONObject = new JSONObject();
      jSONObject.put("id", "1641194171089955");
      jSONObject.put("pkg_name", URLEncoder.encode(paramString3));
      jSONObject.put("download_url", Uri.encode(paramString2, "/"));
      jSONObject.put("external_url", "");
      jSONObject.put("name", URLEncoder.encode("消灭病毒"));
      StringBuilder stringBuilder = new StringBuilder();
      stringBuilder.append(paramString1);
      stringBuilder.append("?toutiao_card_params=");
      ...
      if (k != null) {
        ...
        if (k.C() != null)
          k.C().a("http://sf1-ttcdn-tos.pstatp.com/obj/ttfe/adfe/union_endcard/Lark20190725-175511.png"); 
        if (paramInt == 1) {
          k.j(15);
        } else {
          k.j(5);
      ...
      AdSlot adSlot = (new AdSlot.Builder()).setOrientation(paramInt).build();
      i i = new i(o.a(), k, adSlot);
      i.a(true);
      i.showFullScreenVideoAd(null);
      return;
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7575468-dex2jar.jar!\com\bytedance\sdk\openadsdk\component\reward\d.class
