...
public class d extends AsyncTask<Context, Integer, InputStream> {
  ...
  protected void a(InputStream paramInputStream) {
    ...
    if (paramInputStream == null) {
      g.d(a, "get bks from tss error , result is null");
      return;
    } 
    SecureX509SingleInstance.a(paramInputStream);
  }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued6949884-dex2jar.jar!\com\huawei\secure\android\common\ss\\util\d.class
