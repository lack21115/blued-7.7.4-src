...
public abstract class SSLUtil {
  ...
  public static boolean a(SSLSocket paramSSLSocket, String[] paramArrayOfString) {
    if (paramSSLSocket == null)
      return false; 
  ...
  public static boolean b(SSLSocket paramSSLSocket) {
    return (paramSSLSocket == null) ? false : ((Build.VERSION.SDK_INT > 19) ? a(paramSSLSocket, b) : a(paramSSLSocket, a));
  }
  
  public static boolean b(SSLSocket paramSSLSocket, String[] paramArrayOfString) {
    if (paramSSLSocket == null)
      return false; 
    String[] arrayOfString = paramSSLSocket.getEnabledCipherSuites();
    ArrayList<String> arrayList = new ArrayList();
  ...
  public static boolean c(SSLSocket paramSSLSocket) {
    return (paramSSLSocket == null) ? false : b(paramSSLSocket, c);
  }
  
  public static boolean c(SSLSocket paramSSLSocket, String[] paramArrayOfString) {
    if (paramSSLSocket != null) {
      ...
      try {
        ...
        stringBuilder.append("setEnabledProtocols: exception : ");
        stringBuilder.append(exception.getMessage());
        g.d("SSLUtil", stringBuilder.toString());
      } 
    } 
    return false;
  }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued6949884-dex2jar.jar!\com\huawei\secure\android\common\ssl\SSLUtil.class
