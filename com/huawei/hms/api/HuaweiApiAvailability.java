...
public abstract class HuaweiApiAvailability {
  ...
  public static final int HMS_SDK_VERSION_CODE = 50004301;
  
  public static final String HMS_SDK_VERSION_NAME = "5.0.4.301";
  ...
  static {
    ...
    Integer integer = Integer.valueOf(20503000);
    map.put("HuaweiSns.API", integer);
    a.put("HuaweiPay.API", integer);
    a.put("HuaweiPush.API", integer);
    a.put("HuaweiGame.API", integer);
    a.put("HuaweiOpenDevice.API", Integer.valueOf(20601000));
    map = a;
    integer = Integer.valueOf(20700300);
    map.put("HuaweiIap.API", integer);
    a.put("HuaweiPPSkit.API", integer);
  }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued6949884-dex2jar.jar!\com\huawei\hms\api\HuaweiApiAvailability.class
