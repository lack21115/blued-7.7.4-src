...
public enum ErrorEnum {
  ...
  ERROR_APP_SERVER_NOT_ONLINE,
  ERROR_ARGUMENTS_INVALID,
  ERROR_AUTH_INFO_NOT_EXIST,
  ERROR_AUTO_INITIALIZING,
  ERROR_BIND_SERVICE_SELF_MAPPING,
  ERROR_BUILD_CONTENT_ERROR,
  ERROR_CACHE_SIZE_EXCEED,
  ERROR_CERT_FINGERPRINT_EMPTY,
  ERROR_CERT_FINGERPRINT_ERROR,
  ERROR_CLIENT_API_INVALID,
  ERROR_DELETE_3RD_PARTY_TOKEN_FAILED,
  ERROR_EXECUTE_TIMEOUT,
  ERROR_FETCH_DOMAIN_FAILED,
  ERROR_GET_3RD_PARTY_TOKEN_FAILED,
  ERROR_GET_SCOPE_ERROR,
  ERROR_HMS_CLIENT_API,
  ERROR_HMS_DEVICE_AUTH_FAILED_SELF_MAPPING,
  ERROR_HWID_NOT_LOGIN,
  ...
  ERROR_MSG_CACHE,
  ERROR_MULTISENDER_NO_RIGHT,
  ERROR_NAMING_INVALID,
  ERROR_NOT_ALLOW_CROSS_APPLY,
  ERROR_NOT_IN_SERVICE,
  ERROR_NO_CONNECTION_ID,
  ERROR_NO_CONNECTION_ID_OLD,
  ERROR_NO_DEVICE_ID_TYPE,
  ERROR_NO_DEVICE_ID_TYPE_OLD,
  ERROR_NO_NETWORK,
  ERROR_NO_NETWORK_OLD,
  ERROR_NO_RIGHT,
  ERROR_NO_RIGHT_SELF_MAPPING,
  ERROR_NO_TOKEN,
  ERROR_NO_TOKENSIGN,
  ERROR_NO_TOKEN_OLD,
  ERROR_OPERATION_NOT_SUPPORTED,
  ERROR_OVER_FLOW_CONTROL_SIZE,
  ERROR_PARAM_INVALID,
  ERROR_PERMISSION_EXPIRED,
  ERROR_PERMISSION_LIST_EMPTY,
  ERROR_PERMISSION_NOT_AUTHORIZED,
  ERROR_PERMISSION_NOT_EXIST,
  ERROR_PROFILE_EXCEED,
  ERROR_PUSH_ARGUMENTS_INVALID,
  ERROR_PUSH_CLIENT_API_INVALID,
  ERROR_PUSH_EXECUTE_TIMEOUT,
  ERROR_PUSH_INTERNAL_ERROR,
  ERROR_PUSH_NAMING_INVALID,
  ERROR_PUSH_NOT_IN_SERVICE,
  ERROR_PUSH_SERVER,
  ERROR_PUSH_SERVER_OLD,
  ERROR_RESTRICT_GET_TOKEN,
  ERROR_RETRY_LATER_SELF_MAPPING,
  ERROR_SCOPE_LIST_EMPTY,
  ERROR_SEND_SELF_MAPPING,
  ERROR_SERVICE_NOT_AVAILABLE,
  ERROR_SESSION_INVALID,
  ERROR_SIZE,
  ERROR_SPUSH_ESSION_INVALID,
  ERROR_STORAGE_LOCATION_EMPTY,
  ERROR_TOKENSIGN_VALID,
  ERROR_TOKEN_DECRYPT,
  ERROR_TOKEN_URL_EMPTY,
  ERROR_TOO_MANY_MESSAGES,
  ERROR_TOPIC_EXCEED,
  ERROR_TOPIC_SEND,
  ERROR_TTL_EXCEEDED,
  ERROR_UNKNOWN,
  ERROR_UPSTREAM_DEVICE_NOT_IN_GROUP,
  ERROR_UPSTREAM_STORAGE_LOCATION_EMPTY,
  ERROR_UPSTREAM_TOKENSIGN_VALID,
  ERROR_UPSTREAM_TOKEN_DECRYPT,
  SUCCESS(0, 0, "success");
  ...
  static {
    ...
    int i = 0;
    $VALUES = new ErrorEnum[] { 
        errorEnum, ERROR_NO_TOKEN, ERROR_NO_TOKENSIGN, ERROR_NO_NETWORK, ERROR_SERVICE_NOT_AVAILABLE, ERROR_PUSH_SERVER, ERROR_UNKNOWN, ERROR_NO_RIGHT, ERROR_NO_CONNECTION_ID, ERROR_LENGTH, 
        ERROR_NO_DEVICE_ID_TYPE, ERROR_PARAM_INVALID, ERROR_TOKEN_URL_EMPTY, ERROR_NOT_ALLOW_CROSS_APPLY, ERROR_MULTISENDER_NO_RIGHT, ERROR_TOKEN_DECRYPT, ERROR_TOKENSIGN_VALID, ERROR_TOPIC_EXCEED, ERROR_TOPIC_SEND, ERROR_STORAGE_LOCATION_EMPTY, 
        ERROR_SIZE, ERROR_INVALID_PARAMETERS, ERROR_TOO_MANY_MESSAGES, ERROR_TTL_EXCEEDED, ERROR_UPSTREAM_TOKEN_DECRYPT, ERROR_UPSTREAM_TOKENSIGN_VALID, ERROR_UPSTREAM_DEVICE_NOT_IN_GROUP, ERROR_UPSTREAM_STORAGE_LOCATION_EMPTY, ERROR_CACHE_SIZE_EXCEED, ERROR_MSG_CACHE, 
        ERROR_APP_SERVER_NOT_ONLINE, ERROR_OVER_FLOW_CONTROL_SIZE, ERROR_PUSH_ARGUMENTS_INVALID, ERROR_PUSH_INTERNAL_ERROR, ERROR_PUSH_NAMING_INVALID, ERROR_PUSH_CLIENT_API_INVALID, ERROR_PUSH_EXECUTE_TIMEOUT, ERROR_PUSH_NOT_IN_SERVICE, ERROR_SPUSH_ESSION_INVALID, ERROR_ARGUMENTS_INVALID, 
        ERROR_INTERNAL_ERROR, ERROR_NAMING_INVALID, ERROR_CLIENT_API_INVALID, ERROR_EXECUTE_TIMEOUT, ERROR_NOT_IN_SERVICE, ERROR_SESSION_INVALID, ERROR_API_NOT_SPECIFIED, ERROR_GET_SCOPE_ERROR, ERROR_SCOPE_LIST_EMPTY, ERROR_CERT_FINGERPRINT_EMPTY, 
        ERROR_PERMISSION_LIST_EMPTY, ERROR_AUTH_INFO_NOT_EXIST, ERROR_CERT_FINGERPRINT_ERROR, ERROR_PERMISSION_NOT_EXIST, ERROR_PERMISSION_NOT_AUTHORIZED, ERROR_PERMISSION_EXPIRED, ERROR_NO_NETWORK_OLD, ERROR_NO_RIGHT_SELF_MAPPING, ERROR_NO_CONNECTION_ID_OLD, ERROR_LENGTH_OLD, 
        ERROR_NO_DEVICE_ID_TYPE_OLD, ERROR_PUSH_SERVER_OLD, ERROR_NO_TOKEN_OLD, ERROR_HMS_CLIENT_API, ERROR_OPERATION_NOT_SUPPORTED, ERROR_MAIN_THREAD, ERROR_HMS_DEVICE_AUTH_FAILED_SELF_MAPPING, ERROR_BIND_SERVICE_SELF_MAPPING, ERROR_AUTO_INITIALIZING, ERROR_RETRY_LATER_SELF_MAPPING, 
        ERROR_SEND_SELF_MAPPING, ERROR_MISSING_PROJECT_ID, ERROR_RESTRICT_GET_TOKEN, ERROR_GET_3RD_PARTY_TOKEN_FAILED, ERROR_DELETE_3RD_PARTY_TOKEN_FAILED, ERROR_3RD_PARTY_INTERNAL_ERROR, ERROR_FETCH_DOMAIN_FAILED, ERROR_BUILD_CONTENT_ERROR, ERROR_HWID_NOT_LOGIN, ERROR_PROFILE_EXCEED };
    ENUM_MAPPER = new SparseArray();
    ErrorEnum[] arrayOfErrorEnum = values();
    int j = arrayOfErrorEnum.length;
    while (i < j) {
      ErrorEnum errorEnum1 = arrayOfErrorEnum[i];
      ENUM_MAPPER.put(errorEnum1.internalCode, errorEnum1);
      ENUM_MAPPER.put(errorEnum1.externalCode, errorEnum1);
      i++;
    } 
  }
  
  ErrorEnum(int paramInt1, int paramInt2, String paramString1) {
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued6949884-dex2jar.jar!\com\huawei\hms\aaid\constant\ErrorEnum.class
