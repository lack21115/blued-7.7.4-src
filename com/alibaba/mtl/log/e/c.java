...
public class c {
  ...
  public static byte[] decode(byte[] paramArrayOfbyte, int paramInt1, int paramInt2, int paramInt3) {
    ...
    if (b.process(paramArrayOfbyte, paramInt1, paramInt2, true)) {
      if (b.op == b.output.length)
        return b.output; 
      paramArrayOfbyte = new byte[b.op];
      System.arraycopy(b.output, 0, paramArrayOfbyte, 0, b.op);
  ...
  public static byte[] encode(byte[] paramArrayOfbyte, int paramInt1, int paramInt2, int paramInt3) {
    c c1 = new c(paramInt3, null);
    int i = paramInt2 / 3 * 4;
    boolean bool = c1.do_padding;
    byte b = 2;
    if (bool) {
      paramInt3 = i;
      if (paramInt2 % 3 > 0)
    ...
    c1.output = new byte[i];
    c1.process(paramArrayOfbyte, paramInt1, paramInt2, true);
    if (H || c1.op == i)
      return c1.output; 
  ...
  static class c extends a {
    ...
    public boolean process(byte[] param1ArrayOfbyte, int param1Int1, int param1Int2, boolean param1Boolean) {
      ...
      //   633: istore #7
      //   635: aload_0
      //   636: getfield do_newline : Z
      //   639: ifeq -> 1010
      //   642: aload_0
      //   643: getfield do_cr : Z
      //   646: ifeq -> 666
      //   649: iload_2
      //   650: iconst_1
      //   651: iadd
      ...
      //   887: istore #5
      //   889: aload_0
      //   890: getfield do_newline : Z
      //   893: ifeq -> 930
      //   896: iload_2
      //   897: istore #5
      //   899: aload_0
      //   900: getfield do_cr : Z
      //   903: ifeq -> 917
      //   906: aload #12
      //   908: iload_2
      //   909: bipush #13
      ...
      //   1007: iload_3
      //   1008: istore #7
      //   1010: getstatic com/alibaba/mtl/log/e/c$c.H : Z
      //   1013: ifne -> 1034
      //   1016: aload_0
      //   1017: getfield D : I
      //   1020: ifne -> 1026
      ...
      //   1034: iload #5
      //   1036: istore #8
      //   1038: getstatic com/alibaba/mtl/log/e/c$c.H : Z
      //   1041: ifne -> 1174
      //   1044: iload #7
      //   1046: iload #10
      //   1048: if_icmpne -> 1058
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\com\alibaba\mtl\log\e\c.class
