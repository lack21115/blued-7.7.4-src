...
public final class ReportServiceGrpc {
  ...
  public static MethodDescriptor<TeaProtos.Request, TeaProtos.Response> getReportMethod() {
    // Byte code:
    //   0: getstatic com/blued/das/tea/ReportServiceGrpc.getReportMethod : Lio/grpc/MethodDescriptor;
    //   3: astore_0
    //   4: aload_0
    //   5: ifnonnull -> 93
    //   8: ldc com/blued/das/tea/ReportServiceGrpc
    //   10: monitorenter
    //   11: getstatic com/blued/das/tea/ReportServiceGrpc.getReportMethod : Lio/grpc/MethodDescriptor;
    //   14: astore_1
    //   15: aload_1
    //   16: astore_0
    //   17: aload_1
    ...
    //   30: ldc 'com.blued.das.tea.ReportService'
    //   32: ldc 'Report'
    ...
    //   44: invokestatic getDefaultInstance : ()Lcom/blued/das/tea/TeaProtos$Request;
    ...
    //   53: invokestatic getDefaultInstance : ()Lcom/blued/das/tea/TeaProtos$Response;
    ...
    //   62: new com/blued/das/tea/ReportServiceGrpc$ReportServiceMethodDescriptorSupplier
    //   65: dup
    //   66: ldc 'Report'
    ...
    //   77: astore_0
    //   78: aload_0
    //   79: putstatic com/blued/das/tea/ReportServiceGrpc.getReportMethod : Lio/grpc/MethodDescriptor;
    //   82: ldc com/blued/das/tea/ReportServiceGrpc
    //   84: monitorexit
    //   85: aload_0
    //   86: areturn
    //   87: astore_0
    //   88: ldc com/blued/das/tea/ReportServiceGrpc
    //   90: monitorexit
    //   91: aload_0
    //   92: athrow
    //   93: aload_0
  ...
  public static ServiceDescriptor getServiceDescriptor() {
    // Byte code:
    //   0: getstatic com/blued/das/tea/ReportServiceGrpc.serviceDescriptor : Lio/grpc/ServiceDescriptor;
    //   3: astore_0
    //   4: aload_0
    //   5: ifnonnull -> 61
    //   8: ldc com/blued/das/tea/ReportServiceGrpc
    //   10: monitorenter
    //   11: getstatic com/blued/das/tea/ReportServiceGrpc.serviceDescriptor : Lio/grpc/ServiceDescriptor;
    //   14: astore_1
    //   15: aload_1
    //   16: astore_0
    //   17: aload_1
    //   18: ifnonnull -> 50
    //   21: ldc 'com.blued.das.tea.ReportService'
    //   23: invokestatic newBuilder : (Ljava/lang/String;)Lio/grpc/ServiceDescriptor$Builder;
    //   26: new com/blued/das/tea/ReportServiceGrpc$ReportServiceFileDescriptorSupplier
    //   29: dup
    ...
    //   45: astore_0
    //   46: aload_0
    //   47: putstatic com/blued/das/tea/ReportServiceGrpc.serviceDescriptor : Lio/grpc/ServiceDescriptor;
    //   50: ldc com/blued/das/tea/ReportServiceGrpc
    //   52: monitorexit
    //   53: aload_0
    //   54: areturn
    //   55: astore_0
    //   56: ldc com/blued/das/tea/ReportServiceGrpc
    //   58: monitorexit
    //   59: aload_0
    //   60: athrow
    //   61: aload_0
  ...
  static final class MethodHandlers<Req, Resp> implements ServerCalls.BidiStreamingMethod<Req, Resp>, ServerCalls.ClientStreamingMethod<Req, Resp>, ServerCalls.ServerStreamingMethod<Req, Resp>, ServerCalls.UnaryMethod<Req, Resp> {
    ...
    public void invoke(Req param1Req, StreamObserver<Resp> param1StreamObserver) {
      if (this.methodId == 0) {
        this.serviceImpl.report((TeaProtos.Request)param1Req, (StreamObserver)param1StreamObserver);
        return;
      } 
      throw new AssertionError();
    }
  ...
  public static final class ReportServiceBlockingStub extends AbstractBlockingStub<ReportServiceBlockingStub> {
    ...
    public TeaProtos.Response report(TeaProtos.Request param1Request) {
      return (TeaProtos.Response)ClientCalls.blockingUnaryCall(getChannel(), ReportServiceGrpc.getReportMethod(), getCallOptions(), param1Request);
    }
  }
  ...
  public static final class ReportServiceFutureStub extends AbstractFutureStub<ReportServiceFutureStub> {
    ...
    public ListenableFuture<TeaProtos.Response> report(TeaProtos.Request param1Request) {
  ...
  public static abstract class ReportServiceImplBase implements BindableService {
    ...
    public void report(TeaProtos.Request param1Request, StreamObserver<TeaProtos.Response> param1StreamObserver) {
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7575468-dex2jar.jar!\com\blued\das\tea\ReportServiceGrpc.class
