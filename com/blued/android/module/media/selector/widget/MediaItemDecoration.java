...
public class MediaItemDecoration extends RecyclerView.ItemDecoration {
  ...
  public MediaItemDecoration(Context paramContext, AttributeSet paramAttributeSet) {
    TypedArray typedArray = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.media_divder);
    this.a = typedArray.getColor(R.styleable.media_divder_divider_color, this.a);
    this.b = (int)typedArray.getDimension(R.styleable.media_divder_thickness, this.b);
    this.c = typedArray.getInt(R.styleable.media_divder_orientation, 0);
    this.d = typedArray.getBoolean(R.styleable.media_divder_draw_side, true);
    this.e = typedArray.getInt(R.styleable.media_divder_grid_col_num, 1);
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued5032032-dex2jar.jar!\com\blued\android\module\media\selector\widget\MediaItemDecoration.class
