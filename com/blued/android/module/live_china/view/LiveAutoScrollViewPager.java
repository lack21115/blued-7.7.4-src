...
public class LiveAutoScrollViewPager extends ViewPager {
  ...
  public LiveAutoScrollViewPager(Context paramContext) {
    super(paramContext);
    i();
  }
  
  public LiveAutoScrollViewPager(Context paramContext, AttributeSet paramAttributeSet) {
  ...
  static class MyHandler extends Handler {
    ...
    public MyHandler(LiveAutoScrollViewPager param1LiveAutoScrollViewPager) {
      this.a = new WeakReference<LiveAutoScrollViewPager>(param1LiveAutoScrollViewPager);
    }
    ...
    public void handleMessage(Message param1Message) {
      ...
      if (param1Message.what != 0)
        return; 
      LiveAutoScrollViewPager liveAutoScrollViewPager = this.a.get();
      if (liveAutoScrollViewPager != null) {
        LiveAutoScrollViewPager.b(liveAutoScrollViewPager).a(LiveAutoScrollViewPager.a(liveAutoScrollViewPager));
        liveAutoScrollViewPager.h();
        LiveAutoScrollViewPager.b(liveAutoScrollViewPager).a(LiveAutoScrollViewPager.c(liveAutoScrollViewPager));
        LiveAutoScrollViewPager.a(liveAutoScrollViewPager, LiveAutoScrollViewPager.d(liveAutoScrollViewPager) + LiveAutoScrollViewPager.b(liveAutoScrollViewPager).getDuration());
      } 
    }
  }
}
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued5032032-dex2jar.jar!\com\blued\android\module\live_china\view\LiveAutoScrollViewPager.class
