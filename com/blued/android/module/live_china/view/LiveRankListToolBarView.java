...
public class LiveRankListToolBarView extends FrameLayout implements View.OnClickListener {
  ...
  private OnToolBarItemClickListener m;
  
  public LiveRankListToolBarView(Context paramContext) {
    this(paramContext, null);
  }
  
  public LiveRankListToolBarView(Context paramContext, AttributeSet paramAttributeSet) {
    this(paramContext, paramAttributeSet, 0);
  }
  
  public LiveRankListToolBarView(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    super(paramContext, paramAttributeSet, paramInt);
    this.a = paramContext;
    this.b = LayoutInflater.from(this.a);
    this.b.inflate(R.layout.live_rank_list_tool_bar_view, (ViewGroup)this);
  ...
  public void a(String[] paramArrayOfString) {
    for (int i = 0; i < paramArrayOfString.length; i++) {
      if (i != 0) {
        if (i != 1) {
          if (i == 2)
            this.k.setText(paramArrayOfString[2]); 
        } else {
  ...
  public void onClick(View paramView) {
    if ((paramView.getId() == R.id.layout1 || paramView.getId() == R.id.layout2 || paramView.getId() == R.id.layout3) && this.m != null) {
  ...
  public void setOnToolBarItemClickListener(OnToolBarItemClickListener paramOnToolBarItemClickListener) {
    this.m = paramOnToolBarItemClickListener;
  }
  ...
  public void setToolBtnSelect(int paramInt) {
    ...
    if (paramInt == 0) {
      ...
      this.k.setTextColor(this.a.getResources().getColor(R.color.syc_dark_767676));
    ...
    if (paramInt == 2) {
      this.k.setTextColor(this.a.getResources().getColor(R.color.syc_dark_0a0a0a));
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued5032032-dex2jar.jar!\com\blued\android\module\live_china\view\LiveRankListToolBarView.class
