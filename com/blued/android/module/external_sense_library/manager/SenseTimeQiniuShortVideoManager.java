...
public class SenseTimeQiniuShortVideoManager extends SenseTimeBaseManager {
  ...
  public SenseTimeQiniuShortVideoManager(Context paramContext) {
    this(paramContext, true);
  }
  
  public SenseTimeQiniuShortVideoManager(Context paramContext, boolean paramBoolean) {
  ...
  public int drawFrame(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean) {
    ...
    if (this.mNeedBeautify || this.mNeedSticker || this.mNeedFaceAttribute) {
      ...
      this.mInputTextureId = onBeautifyProcessTexture(this.mInputTextureId, this.mTexHeight, this.mTexWidth, paramInt1, 3, sTHumanAction);
      if (this.result == 0)
        sTHumanAction = this.mHumanActionBeautyOutput; 
      if (this.mCameraChanging)
        return this.mInputTextureId; 
      this.mInputTextureId = onStickerProcessTexture(this.mInputTextureId, this.mTexHeight, this.mTexWidth, paramInt1, 0, 6, sTHumanAction);
    } 
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued5032032-dex2jar.jar!\com\blued\android\module\external_sense_library\manager\SenseTimeQiniuShortVideoManager.class
