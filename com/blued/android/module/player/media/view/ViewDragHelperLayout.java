...
public class ViewDragHelperLayout extends LinearLayout implements ScaleChangeObserver.IScaleChangeObserver {
  private ViewDragHelper a = ViewDragHelper.create((ViewGroup)this, 1.0F, new ViewDragHelper.Callback(this) {
        ...
        public void onViewDragStateChanged(int param1Int) {
          ...
          stringBuilder.append("onViewDragStateChanged = ");
          stringBuilder.append(param1Int);
          Log.a("ViewDragHelperLayout", stringBuilder.toString());
          if (param1Int != 0)
            return; 
          if (ViewDragHelperLayout.d(this.a) != null) {
            ...
            stringBuilder.append("whereFromOut = ");
            stringBuilder.append(ViewDragHelperLayout.f(this.a));
            Log.a("ViewDragHelperLayout", stringBuilder.toString());
        ...
        public void onViewPositionChanged(View param1View, int param1Int1, int param1Int2, int param1Int3, int param1Int4) {
          ...
          StringBuilder stringBuilder = new StringBuilder();
          stringBuilder.append("mMainLeft = ");
          stringBuilder.append(ViewDragHelperLayout.b(this.a));
          Log.a("ViewDragHelperLayout", stringBuilder.toString());
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent) {
    return (paramMotionEvent.getPointerCount() > 1) ? false : this.a.shouldInterceptTouchEvent(paramMotionEvent);
  }
  ...
  public void setOnLayoutStateListener(OnLayoutStateListener paramOnLayoutStateListener) {
    this.f = paramOnLayoutStateListener;
  }
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued5032032-dex2jar.jar!\com\blued\android\module\player\media\view\ViewDragHelperLayout.class
