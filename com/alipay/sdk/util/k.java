...
public class k {
  ...
  public static Drawable a(String paramString, Context paramContext) {
    return a(paramString, paramContext, 480);
  }
  
  public static Drawable a(String paramString, Context paramContext, int paramInt) {
    try {
      ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(a.a(paramString));
    } finally {
      paramString = null;
    } 
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\com\alipay\sd\\util\k.class
