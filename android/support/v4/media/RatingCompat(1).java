  ...
  public static RatingCompat fromRating(Object paramObject) {
    ...
    if (paramObject != null) {
      ...
      if (Build.VERSION.SDK_INT >= 19) {
        rating1 = (Rating)paramObject;
        int i = rating1.getRatingStyle();
        if (rating1.isRated()) {
          switch (i) {
            default:
              return null;
            case 6:
              ratingCompat = newPercentageRating(rating1.getPercentRating());
              break;
            case 3:
            case 4:
            case 5:
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\android\support\v4\media\RatingCompat.class
