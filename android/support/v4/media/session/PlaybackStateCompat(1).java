...
public final class PlaybackStateCompat implements Parcelable {
  ...
  public Object getPlaybackState() {
    if (this.mStateObj == null && Build.VERSION.SDK_INT >= 21) {
      ...
      if (list2 != null) {
        list2 = new ArrayList<CustomAction>(list2.size());
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\android\support\v4\media\session\PlaybackStateCompat.class
