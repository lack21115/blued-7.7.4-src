...
public final class MediaBrowserCompat {
        ...
        try {
          ...
          if (i != 1) {
            if (i != 2) {
              ...
              Bundle bundle2 = stringBuilder.getBundle("data_options");
              MediaSessionCompat.ensureClassLoader(bundle2);
              Bundle bundle3 = stringBuilder.getBundle("data_notify_children_changed_options");
              MediaSessionCompat.ensureClassLoader(bundle3);
              mediaBrowserServiceCallbackImpl.onLoadChildren(messenger, stringBuilder.getString("data_media_item_id"), stringBuilder.getParcelableArrayList("data_media_item_list"), bundle2, bundle3);
              return;
            } 
          ...
          mediaBrowserServiceCallbackImpl.onServiceConnected(messenger, stringBuilder.getString("data_media_item_id"), (MediaSessionCompat.Token)stringBuilder.getParcelable("data_media_session_token"), bundle1);
          return;
      ...
      try {
        for (Map.Entry entry : this.mSubscriptions.entrySet()) {
          ...
          for (i = 0; i < list.size(); i++)
            this.mServiceBinderWrapper.addSubscription(param1String, ((MediaBrowserCompat.SubscriptionCallback)list.get(i)).mToken, list1.get(i), this.mCallbacksMessenger); 
        } 
      } catch (RemoteException remoteException) {
  ...
  class StubApi26 extends SubscriptionCallback.StubApi21 implements MediaBrowserCompatApi26.SubscriptionCallback {
    StubApi26() {
...
/* Location:              D:\code\BluedHook\classes.dex\com.soft.blued7646532-dex2jar.jar!\android\support\v4\media\MediaBrowserCompat.class
